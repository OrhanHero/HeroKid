...
| ✅ **Erledigt** | **Führerschein Klasse B (Stufe 1)** | Neuer Lernbereich mit drei Unterbereichen. Fertig: 77 Verkehrszeichen in fünf Gruppen, selbst als Geometrie gezeichnet (offline, StVO Anlage 1-3 = amtliches Werk), Karteikarten, Quiz, tägliche Fünf-Zeichen-Challenge, Eltern-Einstellungen pro Profil. Offen: Theoriefragen (Stufe 2) und Theorie-Kurs (Stufe 3). Der amtliche Fragenkatalog ist lizenzpflichtig und kommt NICHT in die App - Stufe 2 bringt eigene Fragen zu denselben 14 Sachgebieten. Siehe docs/FUEHRERSCHEIN.md. |

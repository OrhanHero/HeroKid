...
| ✅ **Erledigt** | **Führerschein Klasse B (Stufe 1)** | Neuer Lernbereich mit drei Unterbereichen. Fertig: 77 Verkehrszeichen in fünf Gruppen, selbst als Geometrie gezeichnet (offline, StVO Anlage 1-3 = amtliches Werk), Karteikarten, Quiz, tägliche Fünf-Zeichen-Challenge, Eltern-Einstellungen pro Profil. Offen: Theorie-Kurs (Stufe 3). Siehe docs/FUEHRERSCHEIN.md. |

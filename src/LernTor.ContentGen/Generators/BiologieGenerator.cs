...
public sealed class BiologieGenerator : ExerciseGeneratorBase
{
    ...
    {
        ("Was brauchen Pflanzen für die Fotosynthese?", new[] { "Licht, Wasser und Kohlenstoffdioxid", "Nur Wasser (was so in der Praxis nicht zutrifft)", "Nur Licht" },
        ...
        ("Welcher Farbstoff in den Chloroplasten fängt das Sonnenlicht für die Fotosynthese ein?", new[] { "Chlorophyll", "Melanin", "Hämoglobin - eine verbreitete, aber falsche Annahme" },
            "Chlorophyll", "Chlorophyll ist der grüne Blattfarbstoff, der Lichtenergie für die Fotosynthese einfängt."),
        ("Welches Produkt der Fotosynthese speichert die Pflanze als Energievorrat?", new[] { "Traubenzucker (Glukose)", "Sauerstoff", "Kohlenstoffdioxid, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Was passiert nachts bei Pflanzen in Bezug auf Sauerstoff und Kohlenstoffdioxid (Zellatmung)?", new[] { "Sie atmen wie andere Lebewesen und verbrauchen dabei Sauerstoff", "Sie betreiben nachts noch stärkere Fotosynthese, obwohl das auf den ersten Blick plausibel klingt", "Es passiert überhaupt nichts" },
        ...
        ("Welche Rolle spielt Fotosynthese am Anfang fast jeder Nahrungskette?", new[] { "Pflanzen produzieren als Erste die Energie, die andere Lebewesen weiternutzen", "Fotosynthese hat mit Nahrungsketten nichts zu tun, was die eigentliche Bedeutung des Begriffs verfehlt", "Nur Tiere stehen am Anfang jeder Nahrungskette" },
        ...
        ("Warum ist Abholzung von Wäldern schlecht für den globalen Sauerstoffhaushalt?", new[] { "Weniger Bäume betreiben weniger Fotosynthese und produzieren weniger Sauerstoff", "Abgeholzte Wälder produzieren automatisch mehr Sauerstoff", "Bäume haben keinen Einfluss auf den Sauerstoffgehalt der Luft und deshalb hier nicht zutrifft" },
        ...
        ("Was ist ein Chloroplast im Vergleich zur ganzen Pflanzenzelle?", new[] { "Ein kleiner Bestandteil der Zelle, der die Fotosynthese durchführt", "Die gesamte Pflanzenzelle selbst", "Ein Bestandteil, der nur bei Tieren vorkommt, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] WirbeltiereListe =
    {
        ...
        ("Warum gelten Reptilien wie Eidechsen als wechselwarm?", new[] { "Ihre Körpertemperatur passt sich der Umgebungstemperatur an", "Sie können ihre Temperatur selbst konstant halten, auch wenn das manche zunaechst vermuten wuerden", "Sie leben ausschließlich im Wasser" }, "Ihre Körpertemperatur passt sich der Umgebungstemperatur an",
        ...
        ("Wie bringen die meisten Säugetiere ihre Jungen im Gegensatz zu Vögeln oder Reptilien zur Welt?", new[] { "Lebendgebärend, nicht durch Eier", "Immer durch harte Eier", "Immer durch weiche Eier, was bei genauerem Hinsehen nicht stimmt" }, "Lebendgebärend, nicht durch Eier",
        ...
        ("Was schützt die Haut vieler Reptilien vor Austrocknung, im Gegensatz zur Amphibienhaut?", new[] { "Schuppen", "Federn (was so in der Praxis nicht zutrifft)", "Fell" }, "Schuppen",
        ...
        ("Wie regulieren Vögel und Säugetiere im Gegensatz zu Reptilien ihre Körpertemperatur?", new[] { "Sie sind gleichwarm und halten die Temperatur konstant", "Sie sind wechselwarm wie Reptilien", "Sie haben überhaupt keine Körpertemperatur - eine verbreitete, aber falsche Annahme" }, "Sie sind gleichwarm und halten die Temperatur konstant",
        ...
        ("Warum zählen Wale trotz ihres Lebens im Wasser zu den Säugetieren?", new[] { "Sie säugen ihre Jungen mit Milch und atmen mit Lungen", "Sie haben Kiemen wie Fische", "Sie legen Eier wie Reptilien, was einer genaueren Pruefung nicht standhaelt" }, "Sie säugen ihre Jungen mit Milch und atmen mit Lungen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] PubertaetListe =
    {
        ...
        ("Warum kommt es in der Pubertät häufig zu einem Wachstumsschub?", new[] { "Hormone regen das Knochen- und Muskelwachstum an", "Der Körper hört auf zu wachsen, obwohl das auf den ersten Blick plausibel klingt", "Es liegt nur an der Ernährung" },
        ...
        ("Was ist eine mögliche Ursache für Hautunreinheiten (z.B. Pickel) in der Pubertät?", new[] { "Vermehrte Talgproduktion durch Hormone", "Zu viel Schlaf", "Zu häufiges Zähneputzen, was die eigentliche Bedeutung des Begriffs verfehlt" },
        ...
        ("Warum schwanken die Gefühle bei vielen Jugendlichen in der Pubertät stärker als vorher?", new[] { "Hormone beeinflussen auch die Stimmung", "Das hat nichts mit dem Körper zu tun und deshalb hier nicht zutrifft", "Nur schlechte Laune ist normal" },
        ...
        ("An wen können sich Jugendliche wenden, wenn sie Fragen oder Sorgen zur Pubertät haben?", new[] { "An eine Vertrauensperson, z.B. Eltern, Ärztin/Arzt oder Beratungsstelle", "An niemanden, man muss alles allein herausfinden, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Nur an gleichaltrige Fremde im Internet" },
        ...
        ("Was bedeutet \"körperliche Selbstbestimmung\"?", new[] { "Jeder Mensch entscheidet selbst über seinen eigenen Körper", "Andere Menschen dürfen über meinen Körper bestimmen", "Nur Erwachsene haben ein Recht auf ihren eigenen Körper, auch wenn das manche zunaechst vermuten wuerden" },
        ...
        ("Wo wächst ein ungeborenes Kind während der Schwangerschaft heran?", new[] { "In der Gebärmutter", "Im Magen", "In der Lunge, was bei genauerem Hinsehen nicht stimmt" },
        ...
        ("Wie lange dauert eine menschliche Schwangerschaft ungefähr?", new[] { "Etwa neun Monate", "Etwa ein Monat", "Etwa drei Jahre (was so in der Praxis nicht zutrifft)" },
        ...
        ("Was bezeichnet man ganz allgemein als Verhütung (Empfängnisverhütung)?", new[] { "Maßnahmen, die eine Schwangerschaft verhindern sollen", "Maßnahmen, die eine Schwangerschaft garantieren - eine verbreitete, aber falsche Annahme", "Ein anderes Wort für Pubertät" },
        ...
        ("Warum gilt das Kondom auch als Schutz vor sexuell übertragbaren Krankheiten?", new[] { "Es verhindert den direkten Kontakt von Körperflüssigkeiten", "Es hat damit nichts zu tun", "Es wirkt nur gegen Erkältungen, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Was ist bei der Geburt eines Kindes normalerweise der erste Schritt?", new[] { "Wehen kündigen die Geburt an, dann verlässt das Kind die Gebärmutter über den Geburtskanal", "Das Kind wird sofort operiert", "Die Mutter schläft während der gesamten Geburt, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt" },
        ...
        ("Warum ist es wichtig zu wissen, dass jeder Mensch sich in der Pubertät in seinem eigenen Tempo entwickelt?", new[] { "Damit niemand sich wegen früherer oder späterer Entwicklung schämen oder unter Druck fühlen muss", "Damit alle möglichst schnell erwachsen wirken", "Damit man andere mit ihrer Entwicklung vergleichen und bewerten kann und deshalb hier nicht zutrifft, was so nicht korrekt ist" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] ZellbiologieListe =
    {
        ...
        ("Welcher Zellbestandteil wird als \"Kraftwerk der Zelle\" bezeichnet?", new[] { "Mitochondrium", "Zellkern - eine haeufige, aber unzutreffende Vorstellung", "Ribosom" }, "Mitochondrium",
            "Mitochondrien produzieren durch Zellatmung Energie (ATP) und werden daher \"Kraftwerk der Zelle\" genannt."),
        ("Was unterscheidet eine Pflanzenzelle von einer Tierzelle?", new[] { "Zellwand und Chloroplasten", "Zellkern", "Zellmembran, auch wenn das manche zunaechst vermuten wuerden" }, "Zellwand und Chloroplasten",
        ...
        ("Sind Bakterien Beispiele für Prokaryoten oder Eukaryoten?", new[] { "Prokaryoten", "Eukaryoten, was bei genauerem Hinsehen nicht stimmt", "Weder noch" }, "Prokaryoten",
            "Bakterien haben keinen echten Zellkern und zählen deshalb zu den Prokaryoten."),
        ("Was passiert bei der Zellteilung (Mitose)?", new[] { "Eine Zelle teilt sich in zwei identische Tochterzellen", "Zwei Zellen verschmelzen zu einer (was so in der Praxis nicht zutrifft)", "Eine Zelle verschwindet komplett" }, "Eine Zelle teilt sich in zwei identische Tochterzellen",
        ...
        ("Was ist ein Gen?", new[] { "Ein Abschnitt der DNA, der die Bauanleitung für ein Merkmal/Protein enthält", "Ein anderes Wort für Zellkern", "Ein Bestandteil der Zellmembran - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt" }, "Ein Abschnitt der DNA, der die Bauanleitung für ein Merkmal/Protein enthält",
        ...
        ("Was ist die Aufgabe von Lysosomen in der Zelle?", new[] { "Sie bauen Abfallstoffe und alte Zellbestandteile ab", "Sie speichern die Erbinformation, obwohl das auf den ersten Blick plausibel klingt", "Sie produzieren Sauerstoff" }, "Sie bauen Abfallstoffe und alte Zellbestandteile ab",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] VererbungListe =
    {
        ...
        ("Was ist der Unterschied zwischen Genotyp und Phänotyp?", new[] { "Genotyp ist die genetische Anlage, Phänotyp das sichtbare Erscheinungsbild", "Beides bedeutet dasselbe", "Genotyp ist nur bei Pflanzen wichtig, was die eigentliche Bedeutung des Begriffs verfehlt" },
        ...
        ("Was ist ein rezessives Allel?", new[] { "Ein Allel, das nur sichtbar wird, wenn kein dominantes Allel vorhanden ist", "Ein Allel, das sich immer durchsetzt und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Ein Allel, das gar keine Wirkung hat" },
        ...
        ("Was untersuchte Gregor Mendel in seinen berühmten Kreuzungsversuchen?", new[] { "Erbsenpflanzen mit unterschiedlichen Merkmalen", "Fruchtfliegen im Labor", "Menschliche Familienstammbäume - eine haeufige, aber unzutreffende Vorstellung" },
        ...
        ("Was ist eine Erbkrankheit?", new[] { "Eine Krankheit, die durch veränderte Gene von den Eltern weitergegeben werden kann", "Eine Krankheit, die man sich nur durch Ansteckung holen kann, auch wenn das manche zunaechst vermuten wuerden", "Eine Krankheit, die ausschließlich im Alter entsteht" },
        ...
        ("Was unterscheidet zweieiige Zwillinge genetisch von eineiigen?", new[] { "Sie sind genetisch nicht ähnlicher als normale Geschwister", "Sie haben exakt identisches Erbgut", "Sie haben gar kein Erbgut gemeinsam, was bei genauerem Hinsehen nicht stimmt" },
        ...
        ("Wozu dient Gentechnik in der Landwirtschaft, ein Beispiel?", new[] { "Um Pflanzen widerstandsfähiger gegen Schädlinge zu machen", "Um Pflanzen komplett ohne Erbgut wachsen zu lassen (was so in der Praxis nicht zutrifft)", "Um das Wetter zu beeinflussen" },
        ...
        ("Was bedeutet es, wenn ein Merkmal \"geschlechtsgebunden\" vererbt wird (z.B. Rot-Grün-Sehschwäche)?", new[] { "Das entsprechende Gen liegt auf einem Geschlechtschromosom", "Das Merkmal hat nichts mit Genen zu tun", "Nur Frauen können dieses Merkmal überhaupt vererben - eine verbreitete, aber falsche Annahme" },
    ...
    {
        ("Was bezeichnet man als \"Produzenten\" in einem Ökosystem?", new[] { "Pflanzen, die durch Fotosynthese Energie herstellen", "Tiere, die andere Tiere fressen", "Pilze und Bakterien, die zersetzen, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Welche Rolle haben Destruenten (z.B. Pilze, Bakterien) im Ökosystem?", new[] { "Sie zersetzen abgestorbene Lebewesen und Kreisläufe schließen sich", "Sie produzieren Sauerstoff, obwohl das auf den ersten Blick plausibel klingt", "Sie fressen nur Pflanzen" },
        ...
        ("Was passiert, wenn in einem Ökosystem ein Raubtier (z.B. der Wolf) ausstirbt?", new[] { "Die Beutetiere können sich stark vermehren und das Gleichgewicht verschiebt sich", "Es ändert sich gar nichts", "Alle Pflanzen sterben sofort ab, was die eigentliche Bedeutung des Begriffs verfehlt" },
        ...
        ("Was versteht man unter einer \"Nahrungskette\"?", new[] { "Die Reihenfolge, wer wen als Nahrung nutzt (z.B. Pflanze → Maus → Fuchs)", "Eine Liste von Lebensmitteln im Supermarkt", "Eine Kette aus Metall in der Landwirtschaft und deshalb hier nicht zutrifft, was so nicht korrekt ist" },
        ...
        ("Was bedeutet \"biologisches Gleichgewicht\" in einem Ökosystem?", new[] { "Die Bestände von Pflanzen und Tieren halten sich über längere Zeit ungefähr die Waage", "Alle Tierarten haben exakt gleich viele Individuen - eine haeufige, aber unzutreffende Vorstellung", "Es gibt in einem Ökosystem nur eine einzige Art" },
        ...
        ("Was ist ein \"Konsument\" in einem Ökosystem?", new[] { "Ein Lebewesen, das andere Lebewesen als Nahrung nutzt", "Ein Lebewesen, das Fotosynthese betreibt, auch wenn das manche zunaechst vermuten wuerden", "Ein Lebewesen, das tote Materie zersetzt" },
        ...
        ("Was unterscheidet einen Konsument erster Ordnung von einem Konsument zweiter Ordnung?", new[] { "Erster Ordnung frisst Pflanzen, zweiter Ordnung frisst andere Tiere", "Beide fressen ausschließlich Pflanzen, was bei genauerem Hinsehen nicht stimmt", "Beide fressen ausschließlich Fleisch" },
        ...
        ("Was ist ein \"Nahrungsnetz\" im Unterschied zu einer einfachen Nahrungskette?", new[] { "Ein Nahrungsnetz zeigt mehrere miteinander verknüpfte Nahrungsketten", "Ein Nahrungsnetz zeigt nur eine einzige Art (was so in der Praxis nicht zutrifft)", "Ein Nahrungsnetz betrifft nur Pflanzen" },
        ...
        ("Was ist ein \"Lebensraum\" (Habitat)?", new[] { "Der Ort, an dem ein Lebewesen normalerweise lebt", "Ein anderes Wort für Nahrungskette - eine verbreitete, aber falsche Annahme", "Eine bestimmte Tierart selbst" },
        ...
        ("Was ist eine \"Lebensgemeinschaft\" (Biozönose)?", new[] { "Alle Lebewesen verschiedener Arten, die in einem Gebiet zusammenleben", "Nur eine einzige Tierart in einem Gebiet, was einer genaueren Pruefung nicht standhaelt", "Ein anderes Wort für Nahrungskette" },
        ...
        ("Was passiert, wenn eine invasive (fremde) Tierart in ein Ökosystem eingeführt wird?", new[] { "Sie kann heimische Arten verdrängen und das Gleichgewicht stören", "Es passiert grundsätzlich nichts", "Sie passt sich automatisch perfekt ein, obwohl das auf den ersten Blick plausibel klingt" },
        ...
        ("Was passiert mit der Energie, wenn sie von einer Nahrungskettenstufe zur nächsten weitergegeben wird?", new[] { "Ein großer Teil geht als Wärme verloren, nur ein kleiner Teil wird weitergegeben", "Die gesamte Energie wird vollständig weitergegeben, was die eigentliche Bedeutung des Begriffs verfehlt", "Es entsteht dabei zusätzliche neue Energie" },
        ...
        ("Was ist eine \"Symbiose\" zwischen zwei Arten?", new[] { "Ein enges Zusammenleben, von dem meist beide Arten profitieren", "Ein Kampf zweier Arten um denselben Lebensraum", "Ein Zustand, bei dem eine Art die andere komplett vernichtet und deshalb hier nicht zutrifft" },
        ...
        ("Was passiert mit einem Gewässer-Ökosystem, wenn zu viele Nährstoffe (z.B. Dünger) hineingelangen?", new[] { "Es kann zu übermäßigem Algenwachstum (Eutrophierung) kommen", "Das Gewässer wird automatisch sauberer, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Es passiert überhaupt nichts" },
        ...
        ("Warum sind Korallenriffe ökologisch besonders wertvoll?", new[] { "Sie bieten sehr vielen Meereslebewesen Lebensraum und Nahrung", "Sie sind komplett lebensfeindlich für Meereslebewesen, auch wenn das manche zunaechst vermuten wuerden", "Sie kommen nur in kalten Meeren vor" },
    ...
    {
        ("Was ist der Unterschied zwischen Bakterien und Viren als Krankheitserreger?", new[] { "Bakterien sind eigenständige Zellen, Viren benötigen eine Wirtszelle zur Vermehrung", "Beide sind identisch aufgebaut", "Viren sind größer als Bakterien, was bei genauerem Hinsehen nicht stimmt (was so in der Praxis nicht zutrifft)" }, "Bakterien sind eigenständige Zellen, Viren benötigen eine Wirtszelle zur Vermehrung",
        ...
        ("Was passiert bei einer aktiven Immunisierung (Impfung)?", new[] { "Der Körper wird mit abgeschwächten/inaktiven Erregerbestandteilen konfrontiert und bildet selbst Antikörper", "Fertige Antikörper werden direkt von außen zugeführt, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt", "Es passiert gar nichts im Körper" }, "Der Körper wird mit abgeschwächten/inaktiven Erregerbestandteilen konfrontiert und bildet selbst Antikörper",
        ...
        ("Was passiert bei einer passiven Immunisierung?", new[] { "Fertige Antikörper werden direkt verabreicht, ohne dass der Körper sie selbst bildet", "Der Körper bildet über Wochen selbst Antikörper", "Es handelt sich um dieselbe Methode wie die aktive Immunisierung und deshalb hier nicht zutrifft" }, "Fertige Antikörper werden direkt verabreicht, ohne dass der Körper sie selbst bildet",
        ...
        ("Welches Virus verursacht die Immunschwächekrankheit AIDS?", new[] { "HIV (Humanes Immundefizienz-Virus)", "Das Grippevirus, was so nicht korrekt ist", "Das Masernvirus" }, "HIV (Humanes Immundefizienz-Virus)",
        ...
        ("Warum ist HIV besonders gefährlich für das Immunsystem selbst?", new[] { "Es befällt gezielt T-Helferzellen, die für die Koordination der Abwehr wichtig sind", "Es befällt ausschließlich rote Blutkörperchen - eine haeufige, aber unzutreffende Vorstellung", "Es hat keinerlei Wirkung auf das Immunsystem" }, "Es befällt gezielt T-Helferzellen, die für die Koordination der Abwehr wichtig sind",
        ...
        ("Was ist der Unterschied zwischen einer Epidemie und einer Pandemie?", new[] { "Eine Pandemie betrifft im Unterschied zur regional begrenzten Epidemie viele Länder oder die ganze Welt", "Beide Begriffe bedeuten exakt dasselbe", "Eine Epidemie ist immer weltweit, eine Pandemie nur lokal, was bei genauerem Hinsehen nicht stimmt (was so in der Praxis nicht zutrifft)" }, "Eine Pandemie betrifft im Unterschied zur regional begrenzten Epidemie viele Länder oder die ganze Welt",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] NervensystemListe =
    {
        ...
        ("Was sind Neurotransmitter?", new[] { "Chemische Botenstoffe, die Signale an der Synapse übertragen", "Ein anderes Wort für Hormone der Schilddrüse - eine verbreitete, aber falsche Annahme", "Bestandteile der Zellwand" }, "Chemische Botenstoffe, die Signale an der Synapse übertragen",
        ...
        ("Welche Aufgabe haben Sinnesorgane grundsätzlich?", new[] { "Sie nehmen Reize aus der Umwelt oder dem Körper auf", "Sie speichern ausschließlich Erbinformationen, was einer genaueren Pruefung nicht standhaelt", "Sie produzieren Verdauungsenzyme" }, "Sie nehmen Reize aus der Umwelt oder dem Körper auf",
            "Sinnesorgane (z.B. Auge, Ohr, Haut) nehmen spezifische Reize auf und wandeln sie in Nervenimpulse um."),
        ("Was gehört zum zentralen Nervensystem (ZNS) des Menschen?", new[] { "Gehirn und Rückenmark", "Nur die Sinnesorgane, obwohl das auf den ersten Blick plausibel klingt", "Nur die Muskeln" }, "Gehirn und Rückenmark",
            "Das zentrale Nervensystem besteht aus Gehirn und Rückenmark und verarbeitet und steuert eingehende Informationen."),
        ("Was ist die Aufgabe des vegetativen (autonomen) Nervensystems?", new[] { "Es steuert unbewusste Körperfunktionen wie Herzschlag und Verdauung", "Es steuert ausschließlich bewusste, willkürliche Bewegungen, was die eigentliche Bedeutung des Begriffs verfehlt", "Es hat keine erkennbare Funktion" }, "Es steuert unbewusste Körperfunktionen wie Herzschlag und Verdauung",
        ...
        ("Wie wird ein elektrisches Signal (Aktionspotenzial) entlang eines Axons weitergeleitet?", new[] { "Durch die Bewegung geladener Teilchen (Ionen) über die Zellmembran", "Durch direkten Kontakt mit dem Gehirn ohne jede Signalübertragung und deshalb hier nicht zutrifft", "Durch chemische Reaktionen im Zellkern" }, "Durch die Bewegung geladener Teilchen (Ionen) über die Zellmembran",
        ...
        ("Was passiert am Ende eines Axons, wenn ein elektrisches Signal die Synapse erreicht?", new[] { "Neurotransmitter werden freigesetzt und wirken auf die nächste Zelle", "Das Signal verschwindet einfach spurlos, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Es entsteht eine neue Nervenzelle" }, "Neurotransmitter werden freigesetzt und wirken auf die nächste Zelle",
        ...
        ("Wodurch unterscheiden sich verschiedene Sinnesorgane in der Art der aufgenommenen Reize?", new[] { "Jedes Sinnesorgan ist auf eine bestimmte Reizart spezialisiert, z.B. Auge auf Licht, Ohr auf Schall", "Alle Sinnesorgane nehmen exakt dieselben Reize wahr, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt", "Sinnesorgane nehmen überhaupt keine Reize auf" }, "Jedes Sinnesorgan ist auf eine bestimmte Reizart spezialisiert, z.B. Auge auf Licht, Ohr auf Schall",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] SuchtListe =
    {
        ...
        ("Was ist psychische Abhängigkeit?", new[] { "Ein starkes seelisches Verlangen nach einer Substanz oder einem Verhalten", "Ausschließlich eine körperliche Reaktion ohne jedes Verlangen und deshalb hier nicht zutrifft", "Ein anderes Wort für Immunität" }, "Ein starkes seelisches Verlangen nach einer Substanz oder einem Verhalten",
        ...
        ("Wie beeinflusst Alkohol typischerweise die Signalübertragung im Gehirn?", new[] { "Er verstärkt hemmende Signale und verlangsamt dadurch Reaktionen", "Er hat gar keine Wirkung auf das Gehirn", "Er beschleunigt ausschließlich alle Reaktionen des Körpers, was so nicht korrekt ist" }, "Er verstärkt hemmende Signale und verlangsamt dadurch Reaktionen",
        ...
        ("Was ist ein Beispiel für eine Verhaltenssucht ohne eine chemische Substanz?", new[] { "Glücksspielsucht", "Grippe", "Diabetes - eine haeufige, aber unzutreffende Vorstellung" }, "Glücksspielsucht",
        ...
        ("Was ist ein Beispiel für eine soziale Ursache, die zu Sucht beitragen kann?", new[] { "Gruppendruck oder das Umfeld von Freunden und Familie", "Nur die genetische Veranlagung allein", "Ausschließlich die chemische Struktur der Substanz, auch wenn das manche zunaechst vermuten wuerden" }, "Gruppendruck oder das Umfeld von Freunden und Familie",
        ...
        ("Warum sind Jugendliche laut Forschung teilweise anfälliger für die Entwicklung von Süchten als Erwachsene?", new[] { "Das Gehirn, insbesondere Bereiche für Impulskontrolle, ist noch in der Entwicklung", "Jugendliche haben ein bereits vollständig ausgereiftes Gehirn", "Es gibt keinerlei Unterschied zwischen Jugendlichen und Erwachsenen, was bei genauerem Hinsehen nicht stimmt" }, "Das Gehirn, insbesondere Bereiche für Impulskontrolle, ist noch in der Entwicklung",
        ...
        ("Was unterscheidet Medikamentenmissbrauch von der bestimmungsgemäßen Einnahme von Medikamenten?", new[] { "Missbrauch bedeutet eine unsachgemäße, oft übermäßige Einnahme entgegen ärztlicher Verordnung", "Beides bedeutet exakt dasselbe", "Medikamente können grundsätzlich nicht missbräuchlich verwendet werden - eine verbreitete, aber falsche Annahme" }, "Missbrauch bedeutet eine unsachgemäße, oft übermäßige Einnahme entgegen ärztlicher Verordnung",
        ...
        ("Was versteht man unter \"Co-Abhängigkeit\" im Umfeld einer suchtkranken Person?", new[] { "Nahestehende Personen unterstützen unbewusst das Suchtverhalten mit, statt es zu unterbinden", "Ein anderes Wort für die Sucht selbst", "Ein Zustand, der ausschließlich bei der süchtigen Person selbst auftritt, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Nahestehende Personen unterstützen unbewusst das Suchtverhalten mit, statt es zu unterbinden",
    ...
    {
        ("Was ist der Unterschied zwischen Mitose und Meiose?", new[] { "Mitose bildet zwei identische Körperzellen, Meiose bildet vier unterschiedliche Keimzellen mit halbem Chromosomensatz", "Beide Prozesse führen zu exakt demselben Ergebnis und deshalb hier nicht zutrifft, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Meiose findet nur in Pflanzenzellen statt" }, "Mitose bildet zwei identische Körperzellen, Meiose bildet vier unterschiedliche Keimzellen mit halbem Chromosomensatz",
        ...
        ("Warum ist die Halbierung des Chromosomensatzes bei der Meiose für die Fortpflanzung wichtig?", new[] { "So entsteht bei der Befruchtung wieder der volle, arttypische Chromosomensatz", "Ohne Halbierung könnten sich Zellen nicht teilen", "Die Halbierung hat mit Fortpflanzung nichts zu tun, auch wenn das manche zunaechst vermuten wuerden" }, "So entsteht bei der Befruchtung wieder der volle, arttypische Chromosomensatz",
        ...
        ("Was ist ein Karyogramm?", new[] { "Eine geordnete Darstellung aller Chromosomen eines Menschen zur Untersuchung von Anzahl und Struktur", "Ein anderes Wort für Stammbaum", "Eine Darstellung des Blutkreislaufs, was bei genauerem Hinsehen nicht stimmt (was so in der Praxis nicht zutrifft)" }, "Eine geordnete Darstellung aller Chromosomen eines Menschen zur Untersuchung von Anzahl und Struktur",
        ...
        ("Wie wird die Blutgruppe im AB0-System hauptsächlich bestimmt?", new[] { "Durch bestimmte Merkmale (Antigene) auf der Oberfläche der roten Blutkörperchen", "Durch die Augenfarbe eines Menschen - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt", "Durch das Körpergewicht" }, "Durch bestimmte Merkmale (Antigene) auf der Oberfläche der roten Blutkörperchen",
        ...
        ("Was ist pränatale Diagnostik?", new[] { "Untersuchungsmethoden, die schon vor der Geburt Hinweise auf die Gesundheit des Kindes liefern können", "Eine Untersuchung, die erst nach der Geburt durchgeführt wird, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Impfung" }, "Untersuchungsmethoden, die schon vor der Geburt Hinweise auf die Gesundheit des Kindes liefern können",
        ...
        ("Was kann bei der Auswertung eines Familienstammbaums auf einen rezessiven Erbgang hindeuten?", new[] { "Ein Merkmal tritt nur auf, wenn beide Elternteile das entsprechende Allel tragen, auch wenn sie selbst gesund erscheinen", "Das Merkmal tritt bei jedem einzelnen Nachkommen zwingend auf, was die eigentliche Bedeutung des Begriffs verfehlt und deshalb hier nicht zutrifft", "Rezessive Erbgänge lassen sich nie an Stammbäumen erkennen" }, "Ein Merkmal tritt nur auf, wenn beide Elternteile das entsprechende Allel tragen, auch wenn sie selbst gesund erscheinen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] EvolutionListe =
    {
        ...
        ("Was besagte Lamarcks Theorie der \"Vererbung erworbener Eigenschaften\" (vereinfacht)?", new[] { "Im Laufe des Lebens erworbene Merkmale (z.B. durch Training) würden an die Nachkommen weitergegeben", "Nur zufällige Mutationen könnten vererbt werden", "Erworbene Eigenschaften hätten mit Vererbung nichts zu tun, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt" }, "Im Laufe des Lebens erworbene Merkmale (z.B. durch Training) würden an die Nachkommen weitergegeben",
        ...
        ("Was ist ein Fossil?", new[] { "Ein erhaltener Überrest oder Abdruck eines Lebewesens aus früheren Erdzeitaltern", "Ein lebendes Tier, das heute noch existiert (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme", "Ein anderes Wort für Chromosom" }, "Ein erhaltener Überrest oder Abdruck eines Lebewesens aus früheren Erdzeitaltern",
        ...
        ("Was sind rudimentäre Organe?", new[] { "Zurückgebildete Organe, die im Laufe der Evolution ihre ursprüngliche Funktion verloren haben", "Organe, die erst kürzlich neu entstanden sind", "Organe, die bei allen Lebewesen exakt gleich stark ausgeprägt sind, was einer genaueren Pruefung nicht standhaelt" }, "Zurückgebildete Organe, die im Laufe der Evolution ihre ursprüngliche Funktion verloren haben",
        ...
        ("Was zählt neben Mutation und Selektion als weiterer wichtiger Evolutionsfaktor?", new[] { "Isolation (z.B. geografische Trennung von Populationen)", "Ausschließlich das Wetter", "Nur die Körpergröße eines Lebewesens, obwohl das auf den ersten Blick plausibel klingt" }, "Isolation (z.B. geografische Trennung von Populationen)",
        ...
        ("Wie erklärt die moderne Evolutionsbiologie die Angepasstheit von Organismen an ihre Umwelt?", new[] { "Durch das Zusammenspiel von zufälliger Variabilität und Selektion über viele Generationen", "Durch bewusste Entscheidungen einzelner Lebewesen", "Angepasstheit entsteht ohne jede erkennbare Ursache, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Durch das Zusammenspiel von zufälliger Variabilität und Selektion über viele Generationen",
        ...
        ("Warum betrachten Wissenschaftlerinnen und Wissenschaftler Evolution heute als gut belegte Theorie und nicht als bloße Vermutung?", new[] { "Zahlreiche unabhängige Beweislinien wie Fossilien, Homologien und Genetik stützen sie übereinstimmend", "Es gibt bislang überhaupt keine Belege dafür", "Die Theorie beruht ausschließlich auf einer einzigen Beobachtung, auch wenn das manche zunaechst vermuten wuerden" }, "Zahlreiche unabhängige Beweislinien wie Fossilien, Homologien und Genetik stützen sie übereinstimmend",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] ZelleListe =
    {
        ...
        ("Welcher Zellbestandteil umhüllt jede Zelle nach außen und lässt nur bestimmte Stoffe hindurch?", new[] { "Die Zellmembran", "Der Zellkern - eine verbreitete, aber falsche Annahme", "Die Vakuole" }, "Die Zellmembran",
        ...
        ("Wie viele Zellen hat der menschliche Körper ungefähr (Größenordnung)?", new[] { "Mehrere Billionen", "Genau 100", "Etwa 1.000, was einer genaueren Pruefung nicht standhaelt" }, "Mehrere Billionen",
            "Der menschliche Körper besteht aus mehreren Billionen Zellen, die zusammenarbeiten."),
        ("Was passiert, wenn eine Zelle wächst und sich teilt?", new[] { "Aus einer Zelle entstehen zwei neue Zellen", "Die Zelle verschwindet komplett", "Zwei Zellen verschmelzen zu einer, obwohl das auf den ersten Blick plausibel klingt" }, "Aus einer Zelle entstehen zwei neue Zellen",
            "Bei der Zellteilung entstehen aus einer Zelle zwei neue Zellen - so wächst ein Lebewesen und ersetzt verbrauchte Zellen."),
        ("Wozu dient die Zellteilung z.B. beim Wachstum eines Kindes oder bei der Wundheilung?", new[] { "Um neue Zellen für Wachstum und Reparatur zu bilden", "Um alte Zellen zu vernichten", "Sie hat keinen bestimmten Zweck, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Um neue Zellen für Wachstum und Reparatur zu bilden",
        ...
        ("Was ist ein Gewebe (z.B. Muskelgewebe) im Körper eines Vielzellers?", new[] { "Eine Gruppe gleichartiger Zellen mit gemeinsamer Aufgabe", "Ein anderes Wort für Zellkern", "Ein einzelnes, sehr großes Molekül und deshalb hier nicht zutrifft" }, "Eine Gruppe gleichartiger Zellen mit gemeinsamer Aufgabe",
            "Viele gleichartige Zellen, die zusammen eine bestimmte Aufgabe erfüllen (z.B. Bewegung), bilden ein Gewebe."),
        ("Warum bezeichnet man die Zelle als \"kleinste Funktionseinheit des Lebendigen\"?", new[] { "Weil sie die kleinste Einheit ist, die alle Lebensmerkmale wie Stoffwechsel und Wachstum zeigen kann", "Weil sie das kleinste Molekül im Körper ist, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Weil sie nur bei Pflanzen vorkommt" }, "Weil sie die kleinste Einheit ist, die alle Lebensmerkmale wie Stoffwechsel und Wachstum zeigen kann",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] LebensraeumeListe =
    {
        ...
        ("Wie nennt man Lebewesen wie Pilze und viele Bakterien, die abgestorbene Pflanzen- und Tierreste zersetzen?", new[] { "Destruenten (Zersetzer)", "Produzenten, auch wenn das manche zunaechst vermuten wuerden", "Räuber" }, "Destruenten (Zersetzer)",
        ...
        ("Was ist eine Nahrungskette?", new[] { "Eine feste Reihenfolge von Lebewesen, die sich gegenseitig fressen", "Eine Kette aus Metall, mit der Tiere gefangen werden, was bei genauerem Hinsehen nicht stimmt", "Ein anderes Wort für Lebensraum" }, "Eine feste Reihenfolge von Lebewesen, die sich gegenseitig fressen",
        ...
        ("Wie nennt man ein Tier, das sich ausschließlich von Pflanzen ernährt?", new[] { "Pflanzenfresser (Herbivore)", "Fleischfresser (Carnivore) (was so in der Praxis nicht zutrifft)", "Allesfresser (Omnivore)" }, "Pflanzenfresser (Herbivore)",
        ...
        ("Wie nennt man ein Tier, das sowohl Pflanzen als auch andere Tiere frisst?", new[] { "Allesfresser (Omnivore)", "Reiner Pflanzenfresser - eine verbreitete, aber falsche Annahme", "Destruent" }, "Allesfresser (Omnivore)",
            "Allesfresser wie das Wildschwein oder der Mensch nehmen sowohl pflanzliche als auch tierische Nahrung zu sich."),
        ("Was passiert, wenn in einer Nahrungskette ein Glied - z.B. der Räuber - plötzlich wegfällt?", new[] { "Das Gleichgewicht der ganzen Kette gerät durcheinander", "Es ändert sich überhaupt nichts", "Alle anderen Tiere sterben sofort, was einer genaueren Pruefung nicht standhaelt" }, "Das Gleichgewicht der ganzen Kette gerät durcheinander",
        ...
        ("Warum ist ein Nahrungsnetz eine realistischere Darstellung als eine einzelne Nahrungskette?", new[] { "Weil die meisten Tiere mehrere verschiedene Nahrungsquellen haben und mehrfach vernetzt sind", "Weil ein Nahrungsnetz nur aus einer einzigen Kette besteht, obwohl das auf den ersten Blick plausibel klingt", "Weil im Nahrungsnetz keine Pflanzen vorkommen" }, "Weil die meisten Tiere mehrere verschiedene Nahrungsquellen haben und mehrfach vernetzt sind",
        ...
        ("Welches der folgenden ist ein typischer Lebensraum in Mitteleuropa?", new[] { "Wald, Wiese oder Teich", "Nur die Sahara-Wüste, was die eigentliche Bedeutung des Begriffs verfehlt", "Nur der Nordpol" }, "Wald, Wiese oder Teich",
            "Wald, Wiese, Teich, Hecke oder Fluss sind typische Lebensräume, die man in Mitteleuropa direkt vor der Haustür findet."),
        ("Warum können bestimmte Tiere und Pflanzen nur in bestimmten Lebensräumen überleben?", new[] { "Weil sie an die dortigen Bedingungen wie Klima, Nahrung und Boden angepasst sind", "Weil sie sich das zufällig ausgesucht haben und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Weil andere Lebensräume ihnen verboten sind" }, "Weil sie an die dortigen Bedingungen wie Klima, Nahrung und Boden angepasst sind",
        ...
        ("Was passiert normalerweise mit der Zahl der Beutetiere, wenn es in einem Lebensraum sehr viele Räuber gibt?", new[] { "Sie sinkt, weil mehr Beutetiere gefressen werden", "Sie steigt automatisch stark an - eine haeufige, aber unzutreffende Vorstellung", "Sie bleibt exakt gleich" }, "Sie sinkt, weil mehr Beutetiere gefressen werden",
        ...
        ("Warum sind Regenwürmer für einen Lebensraum wie eine Wiese besonders wichtig?", new[] { "Sie zersetzen abgestorbenes Material und lockern dabei den Boden auf", "Sie betreiben als einzige Tiere Fotosynthese, was bei genauerem Hinsehen nicht stimmt", "Sie jagen als Räuber große Beutetiere" }, "Sie zersetzen abgestorbenes Material und lockern dabei den Boden auf",

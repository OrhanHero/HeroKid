...
public sealed class PhysikGenerator : ExerciseGeneratorBase
{
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] AggregatzustaendeListe =
    {
        ...
        ("In welchem Aggregatzustand ist Wasser bei 100°C (bei normalem Luftdruck)?", new[] { "Fest (Eis) (was so in der Praxis nicht zutrifft)", "Flüssig", "Gasförmig (Wasserdampf)" }, "Gasförmig (Wasserdampf)",
        ...
        ("Wie nennt man den Übergang von flüssig zu gasförmig?", new[] { "Verdampfen (Verdunsten)", "Schmelzen - eine verbreitete, aber falsche Annahme", "Erstarren" }, "Verdampfen (Verdunsten)",
        ...
        ("Wie nennt man den Übergang von gasförmig direkt zu fest (das Gegenteil der Sublimation)?", new[] { "Resublimation", "Kondensation, was einer genaueren Pruefung nicht standhaelt", "Erstarren" }, "Resublimation",
        ...
        ("Was ist Trockeneis?", new[] { "Gefrorenes Kohlenstoffdioxid (CO₂), das direkt zu Gas sublimiert", "Gewöhnliches, sehr kaltes Wassereis, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Schnee" }, "Gefrorenes Kohlenstoffdioxid (CO₂), das direkt zu Gas sublimiert",
        ...
        ("Was passiert mit der Temperatur eines Stoffes während des Schmelzens, obwohl weiter Wärme zugeführt wird?", new[] { "Sie bleibt konstant, bis der Stoff komplett geschmolzen ist", "Sie steigt sofort stark an", "Sie sinkt während des Schmelzens, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Sie bleibt konstant, bis der Stoff komplett geschmolzen ist",
        ...
        ("Was ist Tau, der morgens manchmal auf Gras zu sehen ist?", new[] { "Kondensiertes Wasser aus der Luftfeuchtigkeit", "Gefrorener Regen", "Ein anderes Wort für Nebel und deshalb hier nicht zutrifft" }, "Kondensiertes Wasser aus der Luftfeuchtigkeit",
    ...
    {
        ("Was braucht man mindestens für einen einfachen Stromkreis?", new[] { "Batterie, Kabel und Lampe (geschlossener Kreis)", "Nur eine Batterie, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Nur ein Kabel" },
        ...
        ("Wofür ist eine Sicherung in einem Stromkreis da?", new[] { "Sie unterbricht den Stromkreis automatisch bei zu hoher Stromstärke", "Sie macht Lampen automatisch heller, auch wenn das manche zunaechst vermuten wuerden", "Sie speichert zusätzliche Energie" }, "Sie unterbricht den Stromkreis automatisch bei zu hoher Stromstärke",
            "Eine Sicherung schützt vor Überlastung und Kurzschluss, indem sie den Stromkreis rechtzeitig unterbricht."),
        ("Was misst ein Voltmeter im Stromkreis?", new[] { "Die elektrische Spannung", "Die Stromstärke, was bei genauerem Hinsehen nicht stimmt", "Den Widerstand" }, "Die elektrische Spannung",
        ...
        ("Warum sollte man elektrische Geräte nicht mit nassen Händen berühren?", new[] { "Wasser leitet Strom und erhöht die Gefahr eines Stromschlags", "Wasser macht Strom komplett ungefährlich (was so in der Praxis nicht zutrifft)", "Nasse Hände verhindern jeden Stromfluss" }, "Wasser leitet Strom und erhöht die Gefahr eines Stromschlags",
        ...
        ("Was ist der Unterschied zwischen einem elektrischen Leiter und einem Isolator?", new[] { "Ein Leiter lässt Strom fließen, ein Isolator blockiert ihn weitgehend", "Beide leiten Strom exakt gleich gut", "Ein Isolator leitet Strom besser als ein Leiter - eine verbreitete, aber falsche Annahme" }, "Ein Leiter lässt Strom fließen, ein Isolator blockiert ihn weitgehend",
        ...
        ("Was ist ein \"Schalter\" in einem Stromkreis?", new[] { "Ein Bauteil, mit dem man den Stromkreis öffnen oder schließen kann", "Ein Bauteil, das immer Strom erzeugt, was einer genaueren Pruefung nicht standhaelt", "Ein anderes Wort für Batterie" }, "Ein Bauteil, mit dem man den Stromkreis öffnen oder schließen kann",
        ...
        ("Was ist ein \"Widerstand\" als Bauteil in einem Stromkreis?", new[] { "Ein Bauteil, das den Stromfluss gezielt begrenzt", "Ein Bauteil, das den Strom immer verstärkt, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Schalter" }, "Ein Bauteil, das den Stromfluss gezielt begrenzt",
            "Widerstände werden gezielt eingebaut, um die Stromstärke in einem Stromkreis zu begrenzen oder zu steuern."),
        ("Was passiert mit der Helligkeit einer Lampe, wenn man bei gleicher Spannung den Widerstand im Stromkreis erhöht?", new[] { "Die Lampe leuchtet schwächer, weil weniger Strom fließt", "Die Lampe leuchtet automatisch heller, was die eigentliche Bedeutung des Begriffs verfehlt", "Die Helligkeit bleibt exakt gleich" }, "Die Lampe leuchtet schwächer, weil weniger Strom fließt",
            "Ein größerer Widerstand verringert bei gleicher Spannung die Stromstärke - die Lampe leuchtet dadurch schwächer."),
        ("Welchen Vorteil haben LEDs gegenüber klassischen Glühlampen?", new[] { "Sie verbrauchen deutlich weniger Energie bei ähnlicher Helligkeit", "Sie sind grundsätzlich viel teurer im Betrieb", "Sie funktionieren nur mit Gleichstrom aus Batterien und deshalb hier nicht zutrifft" }, "Sie verbrauchen deutlich weniger Energie bei ähnlicher Helligkeit",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] MagnetismusListe =
    {
        ...
        ("Wonach richtet sich eine frei bewegliche Kompassnadel aus?", new[] { "Nach dem Erdmagnetfeld - sie zeigt nach Norden", "Nach der Sonne", "Nach der Uhrzeit, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" },
        ...
        ("Was ist der Unterschied zwischen einem Dauermagneten und einem Elektromagneten?", new[] { "Ein Dauermagnet ist immer magnetisch, ein Elektromagnet nur bei Stromfluss", "Beide sind exakt identisch", "Ein Dauermagnet funktioniert nur mit Strom, auch wenn das manche zunaechst vermuten wuerden" }, "Ein Dauermagnet ist immer magnetisch, ein Elektromagnet nur bei Stromfluss",
        ...
        ("Ist der geografische Nordpol der Erde exakt identisch mit dem magnetischen Nordpol?", new[] { "Nein, sie liegen an leicht unterschiedlichen Stellen", "Ja, sie sind exakt derselbe Punkt", "Es gibt gar keinen magnetischen Nordpol, was bei genauerem Hinsehen nicht stimmt" }, "Nein, sie liegen an leicht unterschiedlichen Stellen",
        ...
        ("Wofür wird Magnetismus bei alten Kassetten oder Magnetstreifen von Karten genutzt?", new[] { "Zum Speichern von Informationen", "Zum Erzeugen von Licht - eine verbreitete, aber falsche Annahme", "Zum Kühlen von Geräten" }, "Zum Speichern von Informationen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] MessenSinneListe =
    {
        ...
        ("Wie liest man ein Flüssigkeitsthermometer richtig ab?", new[] { "Auf Augenhöhe, an der Oberkante der Flüssigkeitssäule", "Von oben herabschauend", "Die Zahl spielt keine Rolle, obwohl das auf den ersten Blick plausibel klingt" }, "Auf Augenhöhe, an der Oberkante der Flüssigkeitssäule",
        ...
        ("Was zeigt eine Küchenwaage typischerweise an?", new[] { "Das Gewicht von Zutaten in Gramm oder Kilogramm", "Die Temperatur des Ofens, was die eigentliche Bedeutung des Begriffs verfehlt", "Die Kochzeit" }, "Das Gewicht von Zutaten in Gramm oder Kilogramm",
        ...
        ("Was passiert mit der Quecksilber- oder Alkoholsäule in einem Thermometer bei steigender Temperatur?", new[] { "Sie dehnt sich aus und steigt", "Sie schrumpft", "Sie bleibt immer gleich und deshalb hier nicht zutrifft" }, "Sie dehnt sich aus und steigt",
        ...
        ("Warum kann man sich bei der Einschätzung von Gewicht allein mit der Hand leicht täuschen?", new[] { "Weil das Gefühl für Gewicht subjektiv und ungenau ist", "Weil die Hand immer exakt genau wiegt, was so nicht korrekt ist", "Weil Gewicht sich ständig verändert" }, "Weil das Gefühl für Gewicht subjektiv und ungenau ist",
    ...
    {
        ("Was befindet sich im Zentrum unseres Sonnensystems?", new[] { "Die Sonne", "Die Erde - eine haeufige, aber unzutreffende Vorstellung", "Der Mond" }, "Die Sonne",
        ...
        ("Wie entstehen die Jahreszeiten auf der Erde?", new[] { "Durch die geneigte Erdachse und den Umlauf der Erde um die Sonne", "Durch den Mond", "Durch das Wetter allein, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt" }, "Durch die geneigte Erdachse und den Umlauf der Erde um die Sonne",
        ...
        ("Wofür nutzt man ein Fernglas?", new[] { "Um weit entfernte Dinge näher/größer zu sehen", "Um sehr kleine Dinge zu vergrößern (was so in der Praxis nicht zutrifft)", "Um Temperaturen zu messen" }, "Um weit entfernte Dinge näher/größer zu sehen",
            "Ein Fernglas holt weit entfernte Objekte optisch näher heran."),
        ("Wofür nutzt man ein Mikroskop?", new[] { "Um sehr kleine Dinge (z.B. Zellen) stark vergrößert zu sehen", "Um weit entfernte Sterne zu sehen - eine verbreitete, aber falsche Annahme", "Um Gewicht zu messen" }, "Um sehr kleine Dinge (z.B. Zellen) stark vergrößert zu sehen",
            "Ein Mikroskop vergrößert sehr kleine Dinge wie Zellen so stark, dass sie sichtbar werden."),
        ("Was ist ein Schatten?", new[] { "Ein dunkler Bereich, der entsteht, wenn Licht von einem Gegenstand blockiert wird", "Ein besonders heller Lichtstrahl, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt", "Eine Art Spiegel" }, "Ein dunkler Bereich, der entsteht, wenn Licht von einem Gegenstand blockiert wird",
            "Ein Schatten entsteht, wenn ein Gegenstand Licht blockiert und dahinter ein dunkler Bereich bleibt."),
        ("Was passiert mit Licht, wenn es auf eine glatte, glänzende Oberfläche trifft?", new[] { "Es wird reflektiert (zurückgeworfen)", "Es verschwindet komplett, was die eigentliche Bedeutung des Begriffs verfehlt", "Es wird immer absorbiert" }, "Es wird reflektiert (zurückgeworfen)",
            "Glatte, glänzende Oberflächen reflektieren Licht, wie z.B. ein Spiegel."),
        ("Was ist ein Kristall (im Mikrokosmos betrachtet)?", new[] { "Ein Stoff mit regelmäßig angeordneten kleinsten Teilchen", "Eine Flüssigkeit ohne feste Form und deshalb hier nicht zutrifft", "Ein Gas" }, "Ein Stoff mit regelmäßig angeordneten kleinsten Teilchen",
        ...
        ("Warum wird ein Fernglas oft von zwei kleinen Fernrohren (Doppelfernrohr) gebildet?", new[] { "Damit man mit beiden Augen gleichzeitig und räumlich sehen kann", "Damit es schwerer wird", "Das hat keinen besonderen Grund, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" }, "Damit man mit beiden Augen gleichzeitig und räumlich sehen kann",
    ...
    {
        ("Was bedeutet \"Bionik\"?", new[] { "Die Übertragung von Vorbildern aus der Natur auf Technik", "Ein anderes Wort für Biologie, auch wenn das manche zunaechst vermuten wuerden", "Eine Art von Chemie" }, "Die Übertragung von Vorbildern aus der Natur auf Technik",
        ...
        ("Was versteht man unter \"Stromlinienform\"?", new[] { "Eine besonders windschlüpfrige, den Widerstand verringernde Form", "Eine besonders eckige, raue Form, was bei genauerem Hinsehen nicht stimmt (was so in der Praxis nicht zutrifft)", "Eine Form nur bei Vögeln" }, "Eine besonders windschlüpfrige, den Widerstand verringernde Form",
        ...
        ("Warum sind Autos und Flugzeuge oft stromlinienförmig gebaut?", new[] { "Um den Luftwiderstand zu verringern und Energie zu sparen", "Um mehr Luftwiderstand zu erzeugen", "Aus rein ästhetischen Gründen ohne technischen Nutzen - eine verbreitete, aber falsche Annahme" }, "Um den Luftwiderstand zu verringern und Energie zu sparen",
        ...
        ("Warum haben viele schnell schwimmende Tiere (z.B. Delfine) eine glatte Haut?", new[] { "Um den Wasserwiderstand beim Schwimmen zu verringern", "Um mehr Widerstand zu erzeugen, was einer genaueren Pruefung nicht standhaelt", "Aus rein optischen Gründen" }, "Um den Wasserwiderstand beim Schwimmen zu verringern",
        ...
        ("Was passiert mit der Geschwindigkeit eines Radfahrers durch Gegenwind?", new[] { "Sie wird durch den erhöhten Luftwiderstand verringert", "Sie wird automatisch erhöht", "Gegenwind hat keinen Einfluss, obwohl das auf den ersten Blick plausibel klingt" }, "Sie wird durch den erhöhten Luftwiderstand verringert",
            "Gegenwind erhöht den Luftwiderstand und verringert dadurch die Geschwindigkeit."),
        ("Wie hilft eine gebückte Haltung Radfahrenden bei hohen Geschwindigkeiten?", new[] { "Sie verringert den Luftwiderstand", "Sie erhöht den Luftwiderstand, was die eigentliche Bedeutung des Begriffs verfehlt", "Sie hat keinerlei Effekt" }, "Sie verringert den Luftwiderstand",
            "Eine gebückte, stromlinienförmigere Haltung verringert den Luftwiderstand."),
        ("Was zeigt der Vergleich zwischen Vogelflug und Flugzeug in der Bionik?", new[] { "Wie Technik von natürlichen Vorbildern lernen kann", "Dass Natur und Technik nichts gemeinsam haben und deshalb hier nicht zutrifft", "Dass Vögel wie Flugzeuge aus Metall bestehen" }, "Wie Technik von natürlichen Vorbildern lernen kann",
    ...
    {
        ("Was besagt der Energieerhaltungssatz?", new[] { "Energie kann nicht erzeugt oder vernichtet werden, nur umgewandelt", "Energie nimmt mit der Zeit immer ab", "Nur elektrische Energie bleibt erhalten, auch wenn das manche zunaechst vermuten wuerden" },
        ...
        ("Was beschreibt der Begriff \"potenzielle Energie\" (Höhenenergie) am einfachsten?", new[] { "Gespeicherte Energie aufgrund der Lage/Höhe eines Körpers", "Energie, die durch Bewegung entsteht, was bei genauerem Hinsehen nicht stimmt", "Energie aus elektrischem Strom" },
        ...
        ("Welche Energieform ist in einer Batterie gespeichert?", new[] { "Chemische Energie", "Kernenergie", "Bewegungsenergie (was so in der Praxis nicht zutrifft)" }, "Chemische Energie",
            "Batterien speichern Energie in chemischer Form und wandeln sie bei Bedarf in elektrische Energie um."),
        ("In welche Energieformen wird chemische Energie beim Verbrennen von Holz hauptsächlich umgewandelt?", new[] { "Wärmeenergie und Lichtenergie", "Nur in elektrische Energie - eine verbreitete, aber falsche Annahme", "Nur in Bewegungsenergie" }, "Wärmeenergie und Lichtenergie",
        ...
        ("Was bedeutet der \"Wirkungsgrad\" einer Maschine?", new[] { "Der Anteil der eingesetzten Energie, der tatsächlich nutzbar umgesetzt wird", "Die maximale Geschwindigkeit einer Maschine", "Die Farbe, in der eine Maschine lackiert ist, was einer genaueren Pruefung nicht standhaelt" }, "Der Anteil der eingesetzten Energie, der tatsächlich nutzbar umgesetzt wird",
        ...
        ("Warum gelten fossile Energieträger wie Kohle und Öl als nicht erneuerbar?", new[] { "Sie brauchen Millionen Jahre zur Entstehung und sind nur begrenzt vorhanden", "Sie entstehen jeden Tag neu", "Sie sind unbegrenzt verfügbar, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Sie brauchen Millionen Jahre zur Entstehung und sind nur begrenzt vorhanden",
        ...
        ("Warum kommt ein echtes Pendel nach einiger Zeit zur Ruhe, obwohl Energie eigentlich erhalten bleibt?", new[] { "Reibung (Luftwiderstand, Aufhängung) wandelt Bewegungsenergie in Wärme um", "Die Energieerhaltung gilt für Pendel nicht, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Das Pendel verliert einfach Masse" }, "Reibung (Luftwiderstand, Aufhängung) wandelt Bewegungsenergie in Wärme um",
    ...
    {
        ("Was besagt Newtons erstes Gesetz (Trägheitsgesetz)?", new[] { "Ein Körper bleibt in Ruhe oder gleichförmiger Bewegung, solange keine Kraft wirkt", "Jede Kraft erzeugt sofort Wärme, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt", "Kräfte wirken nur bei Berührung" },
        ...
        ("Warum wiegt ein Astronaut auf dem Mond weniger als auf der Erde, obwohl seine Masse gleich bleibt?", new[] { "Die Anziehungskraft (Gravitation) des Mondes ist schwächer als die der Erde", "Der Astronaut verliert auf dem Mond tatsächlich Masse (was so in der Praxis nicht zutrifft)", "Auf dem Mond gibt es überhaupt keine Schwerkraft" }, "Die Anziehungskraft (Gravitation) des Mondes ist schwächer als die der Erde",
        ...
        ("Wie funktioniert der Antrieb einer Rakete nach Newtons drittem Gesetz?", new[] { "Sie stößt Gas nach hinten aus und wird dadurch nach vorne beschleunigt", "Sie wird von der Erde einfach nach oben gezogen - eine verbreitete, aber falsche Annahme", "Sie fliegt nur wegen des Winds"}, "Sie stößt Gas nach hinten aus und wird dadurch nach vorne beschleunigt",
        ...
        ("Warum sind Anschnallgurte im Auto wichtig, wenn ein Auto abrupt bremst?", new[] { "Der Körper würde sich wegen der Trägheit sonst weiter nach vorne bewegen", "Gurte machen das Auto automatisch schneller, was einer genaueren Pruefung nicht standhaelt", "Ohne Gurt bleibt der Körper sofort stehen" }, "Der Körper würde sich wegen der Trägheit sonst weiter nach vorne bewegen",
        ...
        ("Was passiert mit der Bewegungsrichtung eines Balls, wenn keine Kraft (z.B. Reibung) auf ihn wirkt?", new[] { "Er bewegt sich geradeaus mit gleichbleibender Geschwindigkeit weiter", "Er bleibt sofort automatisch stehen, obwohl das auf den ersten Blick plausibel klingt", "Er ändert von selbst seine Richtung" }, "Er bewegt sich geradeaus mit gleichbleibender Geschwindigkeit weiter",
            "Ohne einwirkende Kraft bewegt sich ein Körper laut Trägheitsgesetz geradlinig mit konstanter Geschwindigkeit weiter."),
        ("Wie nennt man die Kraft, mit der die Erde jeden Körper nach unten zieht?", new[] { "Gravitationskraft (Erdanziehungskraft)", "Reibungskraft, was die eigentliche Bedeutung des Begriffs verfehlt", "Magnetkraft" }, "Gravitationskraft (Erdanziehungskraft)",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] MagnetInduktionListe =
    {
        ...
        ("Wie nennt man es, wenn durch ein sich änderndes Magnetfeld in einer Spule eine Spannung erzeugt wird?", new[] { "Elektromagnetische Induktion", "Ohmsches Gesetz - eine haeufige, aber unzutreffende Vorstellung", "Trägheitsgesetz" },
        ...
        ("Was ist der Unterschied zwischen einem Generator und einem Elektromotor (vereinfacht)?", new[] { "Ein Generator wandelt Bewegung in Strom um, ein Motor wandelt Strom in Bewegung um", "Beide Geräte sind technisch exakt identisch verwendet, auch wenn das manche zunaechst vermuten wuerden", "Ein Generator braucht immer Strom als Eingabe" }, "Ein Generator wandelt Bewegung in Strom um, ein Motor wandelt Strom in Bewegung um",
        ...
        ("Wofür können Wirbelströme technisch genutzt werden?", new[] { "Zum berührungslosen Bremsen, z.B. bei manchen Zügen oder Achterbahnen", "Zum Erzeugen von Licht in Glühlampen - eine verbreitete, aber falsche Annahme", "Zum Speichern von Wasser" }, "Zum berührungslosen Bremsen, z.B. bei manchen Zügen oder Achterbahnen",
            "Wirbelstrombremsen nutzen die bremsende Wirkung induzierter Ströme, um berührungslos und verschleißarm zu bremsen."),
        ("Was passiert, wenn ein Magnet in Ruhe direkt neben einer ebenfalls stillstehenden Spule liegt?", new[] { "Es wird keine Spannung induziert, da sich das Magnetfeld nicht ändert", "Es wird eine sehr hohe Spannung induziert", "Die Spule beginnt sich von selbst zu drehen, was einer genaueren Pruefung nicht standhaelt" }, "Es wird keine Spannung induziert, da sich das Magnetfeld nicht ändert",
        ...
        ("Warum ist die Erfindung des Generators durch Induktion so bedeutend für die moderne Stromversorgung?", new[] { "Sie ermöglicht die effiziente Umwandlung von Bewegungsenergie in nutzbaren elektrischen Strom im großen Maßstab", "Sie hat gar keine praktische Bedeutung", "Sie funktioniert nur in kleinen Laboren, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Sie ermöglicht die effiziente Umwandlung von Bewegungsenergie in nutzbaren elektrischen Strom im großen Maßstab",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] KinematikListe =
    {
        ...
        ("Was kennzeichnet eine gleichmäßig beschleunigte Bewegung?", new[] { "Die Geschwindigkeit ändert sich pro Zeiteinheit immer um denselben Betrag", "Die Geschwindigkeit bleibt während der gesamten Bewegung konstant und deshalb hier nicht zutrifft", "Der Körper bewegt sich überhaupt nicht" }, "Die Geschwindigkeit ändert sich pro Zeiteinheit immer um denselben Betrag",
        ...
        ("Was ist der freie Fall ein Beispiel für?", new[] { "Eine gleichmäßig beschleunigte Bewegung durch die Erdanziehungskraft", "Eine gleichförmige Bewegung mit konstanter Geschwindigkeit, was so nicht korrekt ist", "Eine Bewegung völlig ohne jede Beschleunigung" }, "Eine gleichmäßig beschleunigte Bewegung durch die Erdanziehungskraft",
        ...
        ("Wie groß ist die Fallbeschleunigung g auf der Erde ungefähr?", new[] { "Etwa 9,81 m/s²", "Etwa 1 m/s²", "Etwa 100 m/s² - eine haeufige, aber unzutreffende Vorstellung" }, "Etwa 9,81 m/s²",
        ...
        ("Was zeigt die Fläche unter der Kurve in einem v(t)-Diagramm?", new[] { "Den in diesem Zeitraum zurückgelegten Weg", "Die Beschleunigung des Körpers, auch wenn das manche zunaechst vermuten wuerden", "Die Masse des bewegten Körpers" }, "Den in diesem Zeitraum zurückgelegten Weg",
        ...
        ("Was bedeutet es, wenn ein v(t)-Diagramm eine horizontale (waagerechte) Linie zeigt?", new[] { "Der Körper bewegt sich mit konstanter Geschwindigkeit (keine Beschleunigung)", "Der Körper wird gleichmäßig immer schneller", "Der Körper befindet sich in völligem Stillstand - eine verbreitete, aber falsche Annahme" }, "Der Körper bewegt sich mit konstanter Geschwindigkeit (keine Beschleunigung)",
        ...
        ("Was bedeutet es, wenn ein v(t)-Diagramm eine Linie mit konstanter, positiver Steigung zeigt?", new[] { "Der Körper wird gleichmäßig beschleunigt (konstante Beschleunigung)", "Der Körper bewegt sich mit konstanter Geschwindigkeit, was einer genaueren Pruefung nicht standhaelt", "Der Körper bewegt sich überhaupt nicht" }, "Der Körper wird gleichmäßig beschleunigt (konstante Beschleunigung)",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] RadioaktivitaetListe =
    {
        ...
        ("Was passiert mit der Aktivität einer radioaktiven Probe nach jeweils einer weiteren Halbwertszeit?", new[] { "Sie halbiert sich erneut gegenüber dem vorherigen Wert", "Sie verdoppelt sich jedes Mal und deshalb hier nicht zutrifft", "Sie bleibt exakt konstant" }, "Sie halbiert sich erneut gegenüber dem vorherigen Wert",
        ...
        ("Was nutzt ein Kernkraftwerk zur Stromerzeugung grundlegend?", new[] { "Die bei der Kernspaltung freigesetzte Energie erzeugt Wärme, die letztlich Turbinen antreibt", "Es nutzt ausschließlich die direkte Umwandlung von Licht in Strom, auch wenn das manche zunaechst vermuten wuerden", "Kernkraftwerke erzeugen Strom ohne jede Wärmeentwicklung" }, "Die bei der Kernspaltung freigesetzte Energie erzeugt Wärme, die letztlich Turbinen antreibt",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] SchwingungenWellenOptikListe =
    {
        ...
        ("Was ist Beugung bei Wellen?", new[] { "Die Ablenkung einer Welle beim Passieren eines Hindernisses oder einer engen Öffnung", "Ein anderes Wort für die Amplitude einer Welle", "Ein Vorgang, der ausschließlich bei Lichtwellen auftritt, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Die Ablenkung einer Welle beim Passieren eines Hindernisses oder einer engen Öffnung",
        ...
        ("Was zeigt das Farbspektrum, wenn weißes Licht durch ein Prisma fällt?", new[] { "Weißes Licht setzt sich aus verschiedenen Farben (Wellenlängen) zusammen, die unterschiedlich stark gebrochen werden", "Weißes Licht besteht aus nur einer einzigen, festen Wellenlänge, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt", "Ein Prisma verändert die Farbe des Lichts überhaupt nicht" }, "Weißes Licht setzt sich aus verschiedenen Farben (Wellenlängen) zusammen, die unterschiedlich stark gebrochen werden",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] WaermeausdehnungListe =
    {
        ...
        ("Welcher Aggregatzustand (fest, flüssig oder gasförmig) dehnt sich bei Erwärmung meist am stärksten aus?", new[] { "Gasförmig", "Fest", "Flüssig, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Gasförmig",
            "Gase haben die beweglichsten Teilchen und reagieren deshalb am stärksten mit Ausdehnung auf Erwärmung."),
        ("Warum ist Wasser bei der Wärmeausdehnung in der Nähe des Gefrierpunkts eine Ausnahme?", new[] { "Wasser dehnt sich beim Gefrieren aus, statt sich zusammenzuziehen", "Wasser verhält sich exakt wie jeder andere Stoff und deshalb hier nicht zutrifft", "Wasser zieht sich beim Erwärmen immer zusammen" }, "Wasser dehnt sich beim Gefrieren aus, statt sich zusammenzuziehen",
            "Anders als die meisten Stoffe dehnt sich Wasser beim Gefrieren zu Eis aus - deshalb schwimmt Eis auf flüssigem Wasser."),
        ("Warum können Wasserleitungen im Winter platzen, wenn das Wasser darin gefriert?", new[] { "Das gefrierende Wasser dehnt sich aus und übt hohen Druck auf die Leitung aus", "Gefrierendes Wasser zieht sich stark zusammen und reißt die Leitung ein, was so nicht korrekt ist", "Kälte macht Metallrohre grundsätzlich instabil" }, "Das gefrierende Wasser dehnt sich aus und übt hohen Druck auf die Leitung aus",
        ...
        ("Warum lässt man Stromleitungen zwischen zwei Masten oft etwas durchhängen?", new[] { "Damit sie sich bei Kälte zusammenziehen können, ohne zu reißen", "Damit sie besser aussehen", "Damit Vögel bequemer darauf sitzen können - eine haeufige, aber unzutreffende Vorstellung" }, "Damit sie sich bei Kälte zusammenziehen können, ohne zu reißen",
        ...
        ("Warum krümmt sich ein Bimetallstreifen (aus zwei verschiedenen Metallen), wenn er erwärmt wird?", new[] { "Weil sich die zwei Metalle unterschiedlich stark ausdehnen", "Weil sich beide Metalle exakt gleich stark ausdehnen", "Weil Metalle sich bei Wärme überhaupt nicht verändern, auch wenn das manche zunaechst vermuten wuerden" }, "Weil sich die zwei Metalle unterschiedlich stark ausdehnen",
        ...
        ("Wo wird ein Bimetallstreifen im Alltag häufig eingesetzt?", new[] { "In einfachen Thermostaten/Reglern, die auf Temperaturänderung reagieren", "Ausschließlich in Flugzeugtriebwerken, was bei genauerem Hinsehen nicht stimmt", "In gewöhnlichen Fensterscheiben" }, "In einfachen Thermostaten/Reglern, die auf Temperaturänderung reagieren",
        ...
        ("Was passiert grundsätzlich mit den Teilchen eines Stoffs, wenn er erwärmt wird?", new[] { "Sie bewegen sich schneller und brauchen dadurch mehr Platz", "Sie bewegen sich langsamer und rücken enger zusammen - eine verbreitete, aber falsche Annahme", "Sie verändern ihre Bewegung überhaupt nicht" }, "Sie bewegen sich schneller und brauchen dadurch mehr Platz",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] WechselwirkungKraftListe =
    {
        ...
        ("Was ist Reibung?", new[] { "Eine Kraft, die der Bewegung zweier sich berührender Oberflächen entgegenwirkt", "Eine Kraft, die Bewegung immer beschleunigt, was einer genaueren Pruefung nicht standhaelt", "Ein anderes Wort für Schwerkraft" }, "Eine Kraft, die der Bewegung zweier sich berührender Oberflächen entgegenwirkt",
            "Reibung bremst die Bewegung zweier Oberflächen, die sich berühren, ab - je rauer die Oberflächen, desto größer die Reibung."),
        ("Warum ist es auf Eis schwerer zu laufen als auf normalem Asphalt?", new[] { "Weil Eis viel weniger Reibung bietet als Asphalt", "Weil Eis viel mehr Reibung bietet als Asphalt, obwohl das auf den ersten Blick plausibel klingt", "Weil Eis magnetisch ist" }, "Weil Eis viel weniger Reibung bietet als Asphalt",
            "Die glatte Eisoberfläche bietet den Schuhsohlen kaum Reibung, wodurch man leicht ausrutscht."),
        ("Was ist ein Hebel, einfach erklärt?", new[] { "Eine starre Stange, mit der man mit weniger Kraft eine größere Last bewegen kann", "Ein Gerät, das ausschließlich elektrischen Strom misst, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein anderes Wort für Reibung" }, "Eine starre Stange, mit der man mit weniger Kraft eine größere Last bewegen kann",
            "Ein Hebel verstärkt die eingesetzte Kraft, sodass man mit weniger Kraftaufwand eine schwerere Last bewegen kann."),
        ("Warum kann man mit einer langen Brechstange leichter einen schweren Stein bewegen als mit einer kurzen?", new[] { "Ein längerer Hebelarm verstärkt die Wirkung der eingesetzten Kraft", "Eine lange Stange ist automatisch leichter als eine kurze und deshalb hier nicht zutrifft", "Die Länge einer Stange hat keinerlei Einfluss" }, "Ein längerer Hebelarm verstärkt die Wirkung der eingesetzten Kraft",
        ...
        ("Warum spürt man beim Anschieben einer Wand selbst eine Gegenkraft?", new[] { "Die Wand drückt mit derselben Kraft zurück, mit der man selbst gedrückt hat", "Die Wand bewegt sich unbemerkt ein kleines Stück, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Es handelt sich um reine Einbildung" }, "Die Wand drückt mit derselben Kraft zurück, mit der man selbst gedrückt hat",
            "Nach dem Wechselwirkungsprinzip übt die Wand exakt dieselbe Kraft in die Gegenrichtung aus, die man selbst auf sie ausübt."),
        ("Wie wirkt sich eine größere Kraft normalerweise auf die Beschleunigung eines Körpers aus?", new[] { "Eine größere Kraft beschleunigt einen Körper stärker", "Eine größere Kraft verlangsamt den Körper immer", "Kraft hat keinen Einfluss auf die Beschleunigung, auch wenn das manche zunaechst vermuten wuerden" }, "Eine größere Kraft beschleunigt einen Körper stärker",
        ...
        ("Warum ist eine Flaschenzug-Konstruktion nützlich, um schwere Lasten zu heben?", new[] { "Sie verteilt die nötige Kraft auf mehrere Seilstränge und macht das Heben leichter", "Sie macht die Last selbst leichter", "Sie funktioniert nur bei sehr leichten Gegenständen, was einer genaueren Pruefung nicht standhaelt" }, "Sie verteilt die nötige Kraft auf mehrere Seilstränge und macht das Heben leichter",
        ...
        ("Warum ist Fallschirmspringen mit geöffnetem Schirm sicherer als im freien Fall?", new[] { "Der Luftwiderstand wirkt als Gegenkraft und bremst die Fallgeschwindigkeit stark ab", "Der Schirm hat keinerlei Einfluss auf die Fallgeschwindigkeit, was die eigentliche Bedeutung des Begriffs verfehlt", "Der Schirm beschleunigt den Fall zusätzlich" }, "Der Luftwiderstand wirkt als Gegenkraft und bremst die Fallgeschwindigkeit stark ab",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] MechanischeEnergieListe =
    {
        ...
        ("Was ist Bewegungsenergie (kinetische Energie)?", new[] { "Die Energie, die ein sich bewegender Körper besitzt", "Die Energie eines Körpers aufgrund seiner Höhe und deshalb hier nicht zutrifft", "Eine andere Bezeichnung für Wärme" }, "Die Energie, die ein sich bewegender Körper besitzt",
        ...
        ("Ein Ball liegt oben auf einem Turm - welche Energieform besitzt er hauptsächlich?", new[] { "Lageenergie (potenzielle Energie)", "Bewegungsenergie, was so nicht korrekt ist", "Wärmeenergie" }, "Lageenergie (potenzielle Energie)",
            "Solange der Ball ruht, aber in großer Höhe liegt, besitzt er vor allem Lageenergie."),
        ("Was passiert mit der Lageenergie eines fallenden Balls, während er nach unten fällt?", new[] { "Sie wandelt sich zunehmend in Bewegungsenergie um", "Sie verschwindet vollständig - eine haeufige, aber unzutreffende Vorstellung", "Sie wird automatisch größer" }, "Sie wandelt sich zunehmend in Bewegungsenergie um",
        ...
        ("Wann verrichtet man laut Physik KEINE mechanische Arbeit, obwohl man sich anstrengt (z.B. beim Halten einer schweren Tasche ohne Bewegung)?", new[] { "Wenn sich der Körper trotz Kraftaufwand nicht bewegt", "Immer, wenn man eine schwere Last hält, auch wenn das manche zunaechst vermuten wuerden", "Nur, wenn man sich sehr langsam bewegt" }, "Wenn sich der Körper trotz Kraftaufwand nicht bewegt",
        ...
        ("Was ist ein einfaches Beispiel für Lageenergie im Alltag?", new[] { "Wasser in einem hoch gelegenen Stausee", "Ein rollender Ball auf ebener Straße, was bei genauerem Hinsehen nicht stimmt", "Ein sich erwärmender Kochtopf" }, "Wasser in einem hoch gelegenen Stausee",
        ...
        ("Was passiert mit der gesamten mechanischen Energie eines fallenden Balls ohne Luftwiderstand, näherungsweise?", new[] { "Sie bleibt insgesamt ungefähr gleich, wechselt nur die Form", "Sie steigt immer weiter an", "Sie sinkt kontinuierlich auf null (was so in der Praxis nicht zutrifft)" }, "Sie bleibt insgesamt ungefähr gleich, wechselt nur die Form",
        ...
        ("Warum wird beim Bremsen eines Autos Energie in Wärme umgewandelt?", new[] { "Reibung zwischen Bremsen und Rädern wandelt Bewegungsenergie in Wärmeenergie um", "Die Bremsen erzeugen dabei elektrischen Strom", "Beim Bremsen entsteht keinerlei Energieumwandlung - eine verbreitete, aber falsche Annahme" }, "Reibung zwischen Bremsen und Rädern wandelt Bewegungsenergie in Wärmeenergie um",
            "Die Bremsen erzeugen durch Reibung Wärme, wodurch die Bewegungsenergie des Autos abgebaut wird und es langsamer wird."),
        ("Wofür ist ein Trampolin ein gutes Beispiel in Bezug auf Energieumwandlung?", new[] { "Umwandlung von Bewegungsenergie in gespannte Energie des Sprungtuchs und wieder zurück", "Umwandlung von Lageenergie in elektrischen Strom, was einer genaueren Pruefung nicht standhaelt", "Ein Trampolin hat mit Energie nichts zu tun" }, "Umwandlung von Bewegungsenergie in gespannte Energie des Sprungtuchs und wieder zurück",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] ThermischeEnergieListe =
    {
        ...
        ("Warum benutzt man beim Kochen oft Griffe aus Holz oder Kunststoff statt aus Metall?", new[] { "Holz und Kunststoff sind schlechte Wärmeleiter und werden nicht so heiß", "Holz und Kunststoff leiten Wärme besser als Metall, obwohl das auf den ersten Blick plausibel klingt", "Aus rein optischen Gründen" }, "Holz und Kunststoff sind schlechte Wärmeleiter und werden nicht so heiß",
        ...
        ("Was ist der Unterschied zwischen Wärme und Temperatur, vereinfacht?", new[] { "Wärme ist übertragene Energie, Temperatur zeigt an, wie warm/kalt etwas gerade ist", "Beide Begriffe bedeuten exakt dasselbe", "Temperatur ist eine Kraft, Wärme eine Strecke, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Wärme ist übertragene Energie, Temperatur zeigt an, wie warm/kalt etwas gerade ist",
        ...
        ("Warum friert man an einem kalten, windigen Tag stärker als bei gleicher Temperatur ohne Wind?", new[] { "Der Wind trägt die erwärmte Luftschicht um den Körper schneller weg", "Wind erhöht die tatsächliche Lufttemperatur", "Wind hat auf das Kälteempfinden keinerlei Einfluss und deshalb hier nicht zutrifft" }, "Der Wind trägt die erwärmte Luftschicht um den Körper schneller weg",
        ...
        ("Warum werden Häuser oft mit Dämmmaterial an Wänden und Dach ausgestattet?", new[] { "Um den Wärmeverlust nach außen im Winter zu verringern", "Um das Haus schwerer zu machen", "Dämmmaterial hat keinerlei Effekt auf Wärme, was so nicht korrekt ist" }, "Um den Wärmeverlust nach außen im Winter zu verringern",
        ...
        ("Warum beschlägt ein kaltes Fensterglas im Winter von innen, wenn warme, feuchte Raumluft dagegen strömt?", new[] { "Die Luft kühlt am kalten Glas ab und der Wasserdampf kondensiert zu sichtbaren Tröpfchen", "Das Glas selbst produziert Wassertropfen", "Kalte Fenster stoßen grundsätzlich Wasser ab - eine haeufige, aber unzutreffende Vorstellung, auch wenn das manche zunaechst vermuten wuerden" }, "Die Luft kühlt am kalten Glas ab und der Wasserdampf kondensiert zu sichtbaren Tröpfchen",

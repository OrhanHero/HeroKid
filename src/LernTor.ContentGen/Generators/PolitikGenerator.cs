...
public sealed class PolitikGenerator : ExerciseGeneratorBase
{
    ...
    {
        ("Was bedeutet \"Demokratie\" ganz einfach erklärt?", new[] { "Herrschaft des Volkes - alle dürfen mitbestimmen", "Herrschaft eines einzelnen Königs (was so in der Praxis nicht zutrifft)", "Herrschaft des Militärs" },
        ...
        ("Was ist ein wichtiges Merkmal einer Demokratie?", new[] { "Freie Wahlen und Meinungsfreiheit", "Nur eine erlaubte Partei - eine verbreitete, aber falsche Annahme", "Keine Gerichte" }, "Freie Wahlen und Meinungsfreiheit",
        ...
        ("Warum ist eine freie Presse wichtig für eine Demokratie?", new[] { "Sie informiert die Bürger und kontrolliert die Mächtigen", "Sie darf nur Positives über die Regierung schreiben, was einer genaueren Pruefung nicht standhaelt", "Sie ist unwichtig" }, "Sie informiert die Bürger und kontrolliert die Mächtigen",
        ...
        ("Warum ist Meinungsfreiheit wichtig in einer Demokratie?", new[] { "Jeder darf seine Meinung frei äußern und auch die Regierung kritisieren", "Nur die Regierung darf ihre Meinung sagen", "Meinungsfreiheit ist in Demokratien verboten, obwohl das auf den ersten Blick plausibel klingt" }, "Jeder darf seine Meinung frei äußern und auch die Regierung kritisieren",
        ...
        ("Was ist ein \"Rechtsstaat\"?", new[] { "Ein Staat, in dem sich alle - auch die Regierung - an die Gesetze halten müssen", "Ein Staat ohne jegliche Gesetze", "Ein Staat, in dem nur die Regierung Gesetze befolgen muss, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Ein Staat, in dem sich alle - auch die Regierung - an die Gesetze halten müssen",
            "Im Rechtsstaat gilt: Niemand steht über dem Gesetz, auch nicht Politikerinnen und Politiker."),
        ("Was können Bürgerinnen und Bürger tun, wenn sie mit einer politischen Entscheidung nicht einverstanden sind?", new[] { "Friedlich demonstrieren oder eine Petition einreichen", "Nur schweigen und nichts unternehmen und deshalb hier nicht zutrifft", "Die Entscheidung heimlich sabotieren" }, "Friedlich demonstrieren oder eine Petition einreichen",
        ...
        ("Was bedeutet \"Minderheitenschutz\" in einer Demokratie?", new[] { "Auch Menschen mit einer anderen Meinung als die Mehrheit haben geschützte Rechte", "Nur die Mehrheit hat überhaupt Rechte, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Minderheiten dürfen nicht wählen" }, "Auch Menschen mit einer anderen Meinung als die Mehrheit haben geschützte Rechte",
        ...
        ("Warum gibt es in einer Demokratie meist mehrere Parteien zur Auswahl?", new[] { "Damit unterschiedliche Meinungen und Interessen vertreten werden können", "Weil eine einzige Partei gesetzlich verboten ist, auch wenn das manche zunaechst vermuten wuerden", "Damit niemand wählen gehen muss" }, "Damit unterschiedliche Meinungen und Interessen vertreten werden können",
        ...
        ("Was ist ein \"Verein\", und warum ist er ein Beispiel für Mitbestimmung in der Gesellschaft?", new[] { "Ein freiwilliger Zusammenschluss von Menschen, der z.B. demokratisch seinen Vorstand wählt", "Eine staatliche Behörde", "Eine Firma, die Gewinn machen muss, was bei genauerem Hinsehen nicht stimmt (was so in der Praxis nicht zutrifft)" }, "Ein freiwilliger Zusammenschluss von Menschen, der z.B. demokratisch seinen Vorstand wählt",
            "Vereine organisieren sich oft selbst demokratisch, z.B. durch die Wahl eines Vorstands in der Mitgliederversammlung."),
        ("Was bedeutet das Wort \"Grundgesetz\" für Deutschland?", new[] { "Die Verfassung, das oberste Gesetz Deutschlands", "Ein einfaches Gesetz zum Straßenverkehr - eine verbreitete, aber falsche Annahme", "Eine Regel nur für Schulen" }, "Die Verfassung, das oberste Gesetz Deutschlands",
            "Das Grundgesetz steht über allen anderen Gesetzen und legt die Grundordnung des deutschen Staates fest."),
        ("Was ist eine \"Demonstration\"?", new[] { "Eine öffentliche, meist friedliche Versammlung, um eine Meinung oder Forderung zu zeigen", "Ein geheimes Treffen ohne Öffentlichkeit, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt", "Eine Art Gerichtsverhandlung" }, "Eine öffentliche, meist friedliche Versammlung, um eine Meinung oder Forderung zu zeigen",
            "Das Versammlungsrecht erlaubt es, öffentlich und friedlich für oder gegen politische Themen zu demonstrieren."),
        ("Warum ist es wichtig, dass sich auch Kinder und Jugendliche für Politik interessieren?", new[] { "Weil politische Entscheidungen auch ihre eigene Zukunft betreffen", "Weil das gesetzlich vorgeschrieben ist, was die eigentliche Bedeutung des Begriffs verfehlt", "Weil Politik nur Erwachsene betrifft" }, "Weil politische Entscheidungen auch ihre eigene Zukunft betreffen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] BezirkeListe =
    {
        ...
        ("Wer leitet einen Berliner Bezirk?", new[] { "Ein Bezirksbürgermeister/eine Bezirksbürgermeisterin", "Der Bundeskanzler und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Ein König" }, "Ein Bezirksbürgermeister/eine Bezirksbürgermeisterin",
        ...
        ("Wie heißt das Berliner Stadtparlament, das für ganz Berlin zuständig ist?", new[] { "Abgeordnetenhaus", "Bundestag - eine haeufige, aber unzutreffende Vorstellung", "Stadtrat" }, "Abgeordnetenhaus",
            "Das Abgeordnetenhaus von Berlin ist das Landesparlament und beschließt Gesetze für ganz Berlin."),
        ("Wer ist der/die Regierungschef/in von ganz Berlin?", new[] { "Regierender Bürgermeister/Regierende Bürgermeisterin", "Bundeskanzler/in", "Bezirksbürgermeister/in, auch wenn das manche zunaechst vermuten wuerden" }, "Regierender Bürgermeister/Regierende Bürgermeisterin",
        ...
        ("In welchem Bezirk liegt der bekannte Kurfürstendamm (\"Ku'damm\")?", new[] { "Charlottenburg-Wilmersdorf", "Lichtenberg", "Marzahn-Hellersdorf, was bei genauerem Hinsehen nicht stimmt" }, "Charlottenburg-Wilmersdorf",
        ...
        ("In welchem Bezirk steht das Olympiastadion (erbaut für die Olympischen Spiele 1936)?", new[] { "Charlottenburg-Wilmersdorf", "Lichtenberg", "Treptow-Köpenick (was so in der Praxis nicht zutrifft)" }, "Charlottenburg-Wilmersdorf",
    ...
    private static QuizQuestion Wahlrecht(Random r)
    {
        var varianten = new (string Frage, string[] Optionen, string Antwort, string Erklaerung)[]
        {
            ...
            ("Was bedeutet \"allgemeines Wahlrecht\"?", new[] { "Grundsätzlich darf jede/r Bürger/in ab einem bestimmten Alter wählen", "Nur bestimmte Berufsgruppen dürfen wählen - eine verbreitete, aber falsche Annahme", "Nur Männer dürfen wählen" }, "Grundsätzlich darf jede/r Bürger/in ab einem bestimmten Alter wählen",
            ...
            ("Was ist eine \"Wahlbenachrichtigung\"?", new[] { "Ein Schreiben, das informiert, wo und wann man wählen kann", "Der amtliche Stimmzettel selbst, was einer genaueren Pruefung nicht standhaelt", "Eine Einladung zum Wahlkampf" }, "Ein Schreiben, das informiert, wo und wann man wählen kann",
                "Vor einer Wahl erhalten alle Wahlberechtigten eine Wahlbenachrichtigung mit Ort und Zeit ihres Wahllokals."),
            ("Was macht man in der Wahlkabine?", new[] { "Man kreuzt geheim und ungestört seine Stimme auf dem Stimmzettel an", "Man diskutiert laut mit anderen über die Wahl, obwohl das auf den ersten Blick plausibel klingt", "Man zeigt anderen, wen man wählt" }, "Man kreuzt geheim und ungestört seine Stimme auf dem Stimmzettel an",
            ...
            ("Was passiert mit einem falsch oder mehrdeutig ausgefüllten Stimmzettel?", new[] { "Er wird als ungültig gewertet und zählt nicht", "Er zählt automatisch doppelt", "Er wird der Regierungspartei zugerechnet, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Er wird als ungültig gewertet und zählt nicht",
            ...
            ("Was versteht man unter \"Wahlkampf\"?", new[] { "Die Zeit vor einer Wahl, in der Parteien um Stimmen werben", "Ein Streit zwischen Wählern im Wahllokal und deshalb hier nicht zutrifft", "Eine sportliche Veranstaltung" }, "Die Zeit vor einer Wahl, in der Parteien um Stimmen werben",
                "Im Wahlkampf stellen Parteien ihre Programme vor, z.B. durch Plakate, Reden und Fernsehdebatten."),
            ("Was ist ein \"Wahlkreis\"?", new[] { "Ein geografisch abgegrenztes Gebiet, das eine Person direkt in den Bundestag entsenden kann", "Ein anderes Wort für Bundesland", "Ein Fachbegriff für eine politische Partei, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" }, "Ein geografisch abgegrenztes Gebiet, das eine Person direkt in den Bundestag entsenden kann",
            ...
            ("Warum ist das Wahlgeheimnis (geheime Wahl) wichtig?", new[] { "Damit niemand unter Druck gesetzt werden kann, in eine bestimmte Richtung zu wählen", "Damit Wahlergebnisse geheim bleiben und nie veröffentlicht werden, auch wenn das manche zunaechst vermuten wuerden", "Weil das Zählen sonst zu lange dauern würde" }, "Damit niemand unter Druck gesetzt werden kann, in eine bestimmte Richtung zu wählen",
            ...
            ("Was ist neben dem Mindestalter eine weitere Voraussetzung für das Wahlrecht bei der Bundestagswahl?", new[] { "Die deutsche Staatsangehörigkeit", "Ein bestimmtes Einkommen", "Ein abgeschlossenes Studium, was bei genauerem Hinsehen nicht stimmt" }, "Die deutsche Staatsangehörigkeit",
    ...
    {
        ("Welche drei Gewalten gibt es nach dem Prinzip der Gewaltenteilung?", new[] { "Legislative, Exekutive, Judikative", "Regierung, Opposition, Volk (was so in der Praxis nicht zutrifft)", "Bund, Land, Gemeinde" },
        ...
        ("Wer übt in Deutschland die Exekutive (ausführende Gewalt) hauptsächlich aus?", new[] { "Die Regierung und Verwaltung", "Die Gerichte", "Der Bundestag allein - eine verbreitete, aber falsche Annahme" }, "Die Regierung und Verwaltung",
            "Die Exekutive setzt Gesetze um - dazu gehören Bundesregierung, Ministerien und Behörden."),
        ("Warum ist es wichtig, dass die drei Gewalten voneinander unabhängig sind?", new[] { "Damit keine Gewalt zu viel Macht bekommt und sich alle gegenseitig kontrollieren", "Damit alles schneller geht, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt", "Das ist nicht wichtig" }, "Damit keine Gewalt zu viel Macht bekommt und sich alle gegenseitig kontrollieren",
        ...
        ("Wer entwickelte das Prinzip der Gewaltenteilung, das viele moderne Demokratien prägt?", new[] { "Der französische Philosoph Montesquieu", "Ein deutscher Bundeskanzler, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein Berliner Bürgermeister" }, "Der französische Philosoph Montesquieu",
        ...
        ("Wo hat das Bundesverfassungsgericht seinen Sitz?", new[] { "Karlsruhe", "Berlin", "München und deshalb hier nicht zutrifft" }, "Karlsruhe",
            "Anders als viele andere zentrale Institutionen sitzt das Bundesverfassungsgericht nicht in Berlin, sondern in Karlsruhe."),
        ("Warum sind Richterinnen und Richter in Deutschland unabhängig?", new[] { "Damit sie frei von politischem Druck entscheiden können", "Damit sie sich nicht an Gesetze halten müssen", "Damit sie von der Regierung Weisungen bekommen, was so nicht korrekt ist" }, "Damit sie frei von politischem Druck entscheiden können",
        ...
        ("Welche Rolle spielt der Föderalismus zusätzlich zur klassischen Gewaltenteilung in Deutschland?", new[] { "Er verteilt Macht zusätzlich zwischen Bund und Bundesländern", "Er schafft eine einzige zentrale Macht ohne Länder - eine haeufige, aber unzutreffende Vorstellung", "Er betrifft nur die Gerichte" }, "Er verteilt Macht zusätzlich zwischen Bund und Bundesländern",
        ...
        ("Was ist die Hauptaufgabe der Bundespräsidentin bzw. des Bundespräsidenten?", new[] { "Das Land nach außen repräsentieren und Gesetze formal unterzeichnen", "Alle Gesetze selbst schreiben", "Die Bundeswehr im Alltag befehligen, auch wenn das manche zunaechst vermuten wuerden" }, "Das Land nach außen repräsentieren und Gesetze formal unterzeichnen",
        ...
        ("Warum sitzen im Bundesrat Vertreter der Länderregierungen, obwohl er an Gesetzen mitwirkt?", new[] { "Damit die Landesregierungen ihre Interessen direkt bei Bundesgesetzen einbringen können", "Weil das ein reiner Zufall der Geschichte ist", "Weil der Bundestag das so verlangt hat, um Macht abzugeben, was bei genauerem Hinsehen nicht stimmt" }, "Damit die Landesregierungen ihre Interessen direkt bei Bundesgesetzen einbringen können",
            "Der Bundesrat gibt den Bundesländern eine direkte Stimme bei Bundesgesetzen, die sie betreffen."),
        ("Was passiert, wenn das Bundesverfassungsgericht ein Gesetz für verfassungswidrig erklärt?", new[] { "Das Gesetz verliert seine Gültigkeit bzw. muss angepasst werden", "Das Gesetz gilt trotzdem unverändert weiter (was so in der Praxis nicht zutrifft)", "Der Bundestag wird automatisch aufgelöst" }, "Das Gesetz verliert seine Gültigkeit bzw. muss angepasst werden",
            "Ein für verfassungswidrig erklärtes Gesetz kann nicht bestehen bleiben - es muss geändert oder aufgehoben werden."),
        ("Warum gilt Gewaltenteilung als wichtiger Schutz für die Bürgerinnen und Bürger?", new[] { "Weil keine einzelne Institution unkontrolliert über sie bestimmen kann", "Weil dadurch alles schneller entschieden wird", "Weil es dadurch überhaupt keine Regeln mehr gibt - eine verbreitete, aber falsche Annahme" }, "Weil keine einzelne Institution unkontrolliert über sie bestimmen kann",
    ...
    {
        ("Was ist die Hauptaufgabe des Bundestags?", new[] { "Gesetze beschließen und die Regierung kontrollieren", "Gerichtsurteile fällen, was einer genaueren Pruefung nicht standhaelt", "Die Polizei leiten" },
        ...
        ("Was vertritt der Bundesrat?", new[] { "Die Interessen der 16 Bundesländer", "Nur die Interessen Berlins, obwohl das auf den ersten Blick plausibel klingt", "Die Vereinten Nationen" }, "Die Interessen der 16 Bundesländer",
        ...
        ("Wer leitet die Sitzungen des Bundestags?", new[] { "Die Bundestagspräsidentin/der Bundestagspräsident", "Die Bundeskanzlerin/der Bundeskanzler, was die eigentliche Bedeutung des Begriffs verfehlt", "Der Bundespräsident allein" }, "Die Bundestagspräsidentin/der Bundestagspräsident",
        ...
        ("Wie nennt man den Zeitraum zwischen zwei Bundestagswahlen?", new[] { "Wahlperiode (Legislaturperiode)", "Amnestie", "Koalitionsvertrag und deshalb hier nicht zutrifft" }, "Wahlperiode (Legislaturperiode)",
        ...
        ("In welchem Gebäude finden die Bundestagssitzungen im Plenum statt?", new[] { "Im Reichstagsgebäude", "Im Schloss Bellevue, was so nicht korrekt ist", "Im Roten Rathaus" }, "Im Reichstagsgebäude",
        ...
        ("Was ist eine \"namentliche Abstimmung\" im Bundestag?", new[] { "Eine Abstimmung, bei der für jede Person einzeln festgehalten wird, wie sie gestimmt hat", "Eine geheime Abstimmung ohne jede Dokumentation", "Eine Abstimmung nur der Bundestagspräsidentin allein, auch wenn das manche zunaechst vermuten wuerden" }, "Eine Abstimmung, bei der für jede Person einzeln festgehalten wird, wie sie gestimmt hat",
    ...
    {
        ("Bei der Bundestagswahl hat jeder Wähler zwei Stimmen. Wofür ist die Zweitstimme wichtig?", new[] { "Sie entscheidet über die Sitzverteilung der Parteien im Bundestag", "Sie wählt nur den Bundeskanzler direkt, was bei genauerem Hinsehen nicht stimmt", "Sie zählt nicht" },
        ...
        ("Was ist eine \"Minderheitsregierung\"?", new[] { "Eine Regierung, die im Parlament keine eigene Mehrheit hat", "Eine Regierung nur aus kleinen Parteien", "Eine Regierung, die von Minderjährigen gewählt wurde (was so in der Praxis nicht zutrifft)" }, "Eine Regierung, die im Parlament keine eigene Mehrheit hat",
        ...
        ("Was ist eine \"vorgezogene Neuwahl\"?", new[] { "Eine Bundestagswahl, die früher als nach den regulären vier Jahren stattfindet", "Eine Wahl, die um vier Jahre verschoben wird", "Eine zweite, wiederholte Auszählung derselben Wahl - eine verbreitete, aber falsche Annahme" }, "Eine Bundestagswahl, die früher als nach den regulären vier Jahren stattfindet",
        ...
        ("Was zeigen \"Hochrechnungen\" am Wahlabend, bevor alle Stimmen ausgezählt sind?", new[] { "Eine vorläufige Schätzung des Wahlergebnisses", "Das endgültige, amtliche Endergebnis, was einer genaueren Pruefung nicht standhaelt", "Die Wahlergebnisse der nächsten Wahl" }, "Eine vorläufige Schätzung des Wahlergebnisses",
        ...
        ("Was war ein Ziel der Bundestagswahlrechtsreform von 2023?", new[] { "Die Größe des Bundestags dauerhaft zu begrenzen", "Die Wahlpflicht in Deutschland einzuführen, obwohl das auf den ersten Blick plausibel klingt", "Die 5%-Hürde komplett abzuschaffen" }, "Die Größe des Bundestags dauerhaft zu begrenzen",
        ...
        ("Was passiert mit Stimmen für eine Partei, die an der 5%-Hürde scheitert?", new[] { "Sie fließen nicht in die Sitzverteilung des Bundestags ein", "Sie werden automatisch der stärksten Partei zugerechnet, was die eigentliche Bedeutung des Begriffs verfehlt", "Die Wahl muss deswegen wiederholt werden" }, "Sie fließen nicht in die Sitzverteilung des Bundestags ein",
        ...
        ("Wie heißt das mathematische Verfahren, mit dem in Deutschland Bundestagssitze proportional auf Parteien verteilt werden?", new[] { "Sainte-Laguë/Schepers-Verfahren", "Das Würfelverfahren", "Das Alphabet-Verfahren, auch wenn das manche zunaechst vermuten wuerden" }, "Sainte-Laguë/Schepers-Verfahren",
    ...
    {
        ("Was ist das Grundprinzip der Sozialen Marktwirtschaft in Deutschland?", new[] { "Freier Markt und Wettbewerb, kombiniert mit sozialer Absicherung durch den Staat", "Der Staat bestimmt alle Preise und Löhne", "Es gibt keinerlei staatliche Regeln für die Wirtschaft, was bei genauerem Hinsehen nicht stimmt" },
        ...
        ("Welche Aufgabe hat der Staat in der Sozialen Marktwirtschaft?", new[] { "Er setzt Regeln (z.B. gegen Monopole) und sichert soziale Absicherung ab", "Er verbietet jeglichen privaten Handel", "Er hat gar keine Aufgabe in der Wirtschaft (was so in der Praxis nicht zutrifft)" },
        ...
        ("Was gehört in Deutschland zum sozialen Sicherungssystem?", new[] { "Kranken-, Renten- und Arbeitslosenversicherung", "Nur die private Altersvorsorge", "Ausschließlich Steuern auf Lebensmittel - eine verbreitete, aber falsche Annahme" },
        ...
        ("Was ist der Mindestlohn?", new[] { "Der niedrigste erlaubte Stundenlohn in Deutschland", "Das höchste erlaubte Gehalt", "Eine freiwillige Zahlung von Firmen, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Was passiert bei starkem Wettbewerb zwischen Firmen normalerweise mit den Preisen?", new[] { "Sie tendieren eher dazu, niedrig zu bleiben", "Sie steigen automatisch stark", "Wettbewerb hat keinen Einfluss auf Preise, obwohl das auf den ersten Blick plausibel klingt" },
        ...
        ("Was ist die Aufgabe des Bundeskartellamts?", new[] { "Es verhindert, dass einzelne Unternehmen den Markt unfair beherrschen", "Es setzt die Löhne aller Berufe fest, was die eigentliche Bedeutung des Begriffs verfehlt", "Es druckt neues Geld" }, "Es verhindert, dass einzelne Unternehmen den Markt unfair beherrschen",
            "Das Kartellamt überwacht den Wettbewerb und greift z.B. ein, wenn Unternehmen unerlaubte Preisabsprachen treffen."),
        ("Was sind \"Tarifverhandlungen\"?", new[] { "Verhandlungen zwischen Gewerkschaften und Arbeitgebern über Löhne und Arbeitsbedingungen", "Verhandlungen über Zölle zwischen Ländern", "Gespräche zwischen Parteien vor einer Wahl und deshalb hier nicht zutrifft, was so nicht korrekt ist" }, "Verhandlungen zwischen Gewerkschaften und Arbeitgebern über Löhne und Arbeitsbedingungen",
        ...
        ("Was ist eine \"Gewerkschaft\"?", new[] { "Eine Organisation, die die Interessen von Arbeitnehmerinnen und Arbeitnehmern vertritt", "Eine staatliche Steuerbehörde", "Ein Zusammenschluss von Unternehmerinnen und Unternehmern - eine haeufige, aber unzutreffende Vorstellung" }, "Eine Organisation, die die Interessen von Arbeitnehmerinnen und Arbeitnehmern vertritt",
            "Gewerkschaften setzen sich gebündelt für bessere Löhne und Arbeitsbedingungen ihrer Mitglieder ein."),
        ("Was bedeutet \"Steuerprogression\" in Deutschland (vereinfacht)?", new[] { "Wer mehr verdient, zahlt einen höheren Steuersatz", "Alle zahlen exakt denselben Steuersatz", "Wer mehr verdient, zahlt gar keine Steuern, auch wenn das manche zunaechst vermuten wuerden" }, "Wer mehr verdient, zahlt einen höheren Steuersatz",
        ...
        ("Was bedeutet \"Wirtschaftswachstum\", gemessen z.B. am Bruttoinlandsprodukt (BIP)?", new[] { "Die Wirtschaftsleistung eines Landes nimmt in einem Zeitraum zu", "Die Bevölkerung eines Landes wird kleiner (was so in der Praxis nicht zutrifft)", "Ein Land druckt mehr Geld" }, "Die Wirtschaftsleistung eines Landes nimmt in einem Zeitraum zu",
        ...
        ("Was passiert, wenn ein einzelnes Unternehmen ein Monopol hat (einziger Anbieter am Markt)?", new[] { "Es kann Preise ohne Konkurrenzdruck bestimmen, was Kundinnen und Kunden benachteiligen kann", "Der Preis fällt automatisch auf null", "Andere Unternehmen dürfen automatisch günstiger anbieten - eine verbreitete, aber falsche Annahme" }, "Es kann Preise ohne Konkurrenzdruck bestimmen, was Kundinnen und Kunden benachteiligen kann",
    ...
    {
        ("Was bedeutet \"politische Willensbildung\"?", new[] { "Der Prozess, in dem sich Meinungen und Forderungen zu politischen Positionen entwickeln", "Ein anderes Wort für Gerichtsverfahren", "Ein Begriff, der nur die Regierung selbst betrifft, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt" }, "Der Prozess, in dem sich Meinungen und Forderungen zu politischen Positionen entwickeln",
        ...
        ("Was ist ein Verfassungsschutz in Deutschland?", new[] { "Eine Behörde, die Bestrebungen gegen die freiheitliche demokratische Grundordnung beobachtet", "Eine Organisation, die ausschließlich Gebäude vor Einbrüchen schützt, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Ein anderes Wort für die Polizei im Straßenverkehr" }, "Eine Behörde, die Bestrebungen gegen die freiheitliche demokratische Grundordnung beobachtet",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] KonflikteAkteureListe =
    {
        ...
        ("Was ist eine grundlegende Definition von \"Terrorismus\"?", new[] { "Gezielte Gewaltanwendung, um durch Angst und Einschüchterung politische Ziele zu erreichen", "Ein anderes Wort für jede Form von politischem Protest (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme", "Eine Form der parlamentarischen Opposition" }, "Gezielte Gewaltanwendung, um durch Angst und Einschüchterung politische Ziele zu erreichen",
        ...
        ("Welche Aufgabe haben die Vereinten Nationen (UN) im internationalen Konfliktmanagement?", new[] { "Vermittlung, Friedenssicherung und internationale Zusammenarbeit zwischen Staaten", "Die alleinige militärische Kontrolle über alle Staaten der Welt", "Ausschließlich wirtschaftliche Fragen ohne jeden politischen Bezug, was einer genaueren Pruefung nicht standhaelt" }, "Vermittlung, Friedenssicherung und internationale Zusammenarbeit zwischen Staaten",
        ...
        ("Was ist die Aufgabe der EU als internationaler Akteur der Friedenssicherung?", new[] { "Wirtschaftliche und politische Zusammenarbeit zwischen Mitgliedstaaten fördern, um Konflikte in Europa zu verhindern", "Ausschließlich militärische Interventionen weltweit durchzuführen, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt", "Sie hat mit Friedenssicherung nichts zu tun" }, "Wirtschaftliche und politische Zusammenarbeit zwischen Mitgliedstaaten fördern, um Konflikte in Europa zu verhindern",
        ...
        ("Was ist die Aufgabe der NATO als internationaler Akteur?", new[] { "Ein Verteidigungsbündnis, das sich gegenseitigen Beistand seiner Mitgliedstaaten verpflichtet", "Eine rein wirtschaftliche Freihandelszone", "Ein internationales Gericht für Zivilrecht und deshalb hier nicht zutrifft, was so nicht korrekt ist" }, "Ein Verteidigungsbündnis, das sich gegenseitigen Beistand seiner Mitgliedstaaten verpflichtet",
        ...
        ("Was können \"Blauhelm-Missionen\" der Vereinten Nationen bewirken?", new[] { "Sie sollen Frieden sichern helfen, z.B. durch Überwachung von Waffenstillständen", "Sie führen ausschließlich eigene Angriffskriege - eine haeufige, aber unzutreffende Vorstellung", "Sie haben mit Friedenssicherung nichts zu tun" }, "Sie sollen Frieden sichern helfen, z.B. durch Überwachung von Waffenstillständen",
        ...
        ("Was versteht man unter \"humanitärer Hilfe\" in Konfliktregionen?", new[] { "Unterstützung mit Nahrung, medizinischer Versorgung und Schutz für notleidende Menschen", "Ausschließlich militärische Unterstützung einer Konfliktpartei, was bei genauerem Hinsehen nicht stimmt", "Wirtschaftliche Sanktionen gegen eine Konfliktpartei" }, "Unterstützung mit Nahrung, medizinischer Versorgung und Schutz für notleidende Menschen",
        ...
        ("Was ist eine \"Krisenregion\"?", new[] { "Ein Gebiet mit anhaltenden politischen, militärischen oder gesellschaftlichen Spannungen und Konflikten", "Ein besonders friedliches und stabiles Gebiet, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt", "Ein Gebiet ohne jegliche Bevölkerung" }, "Ein Gebiet mit anhaltenden politischen, militärischen oder gesellschaftlichen Spannungen und Konflikten",
    ...
    {
        ("Was versteht man unter \"ziviler Konfliktbearbeitung\"?", new[] { "Gewaltfreie Methoden wie Vermittlung und Dialog zur Lösung von Konflikten", "Ausschließlich militärische Mittel zur Konfliktlösung und deshalb hier nicht zutrifft", "Ein anderes Wort für einen Waffenstillstand" }, "Gewaltfreie Methoden wie Vermittlung und Dialog zur Lösung von Konflikten",
        ...
        ("Was ist ein Beispiel für ein Instrument ziviler Konfliktbearbeitung?", new[] { "Vermittlungsgespräche zwischen verfeindeten Gruppen durch neutrale Dritte", "Ein militärischer Angriff auf eine Konfliktpartei, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Wirtschaftliche Sanktionen ohne jeden Dialog" }, "Vermittlungsgespräche zwischen verfeindeten Gruppen durch neutrale Dritte",
        ...
        ("Wie kann nachhaltige Entwicklungspolitik zur Friedenssicherung beitragen?", new[] { "Sie kann Armut und soziale Ungleichheit verringern, die oft Konfliktursachen sind", "Entwicklungspolitik hat mit Friedenssicherung grundsätzlich nichts zu tun, auch wenn das manche zunaechst vermuten wuerden", "Sie verschärft Konflikte in jedem Fall zusätzlich" }, "Sie kann Armut und soziale Ungleichheit verringern, die oft Konfliktursachen sind",
        ...
        ("Was ist die außenpolitische Rolle Deutschlands im internationalen Vergleich oft beschrieben?", new[] { "Als wirtschaftlich starkes Land mit Engagement in internationalen Organisationen wie UN und EU", "Als Land, das sich aus jeglicher internationalen Politik komplett heraushält, was bei genauerem Hinsehen nicht stimmt", "Als Land ohne jede außenpolitische Bedeutung" }, "Als wirtschaftlich starkes Land mit Engagement in internationalen Organisationen wie UN und EU",
        ...
        ("Was ist ein Beispiel für eine Rolle, die eine zivile Friedenshelferin bzw. ein ziviler Friedenshelfer in einem Krisengebiet übernehmen könnte?", new[] { "Vermittlung zwischen verfeindeten lokalen Gruppen und Unterstützung beim Dialogaufbau", "Die Leitung eines militärischen Kampfeinsatzes", "Die alleinige politische Führung des Krisenlandes, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt" }, "Vermittlung zwischen verfeindeten lokalen Gruppen und Unterstützung beim Dialogaufbau",
        ...
        ("Was ist ein Zielkonflikt, der bei Entwicklungspolitik häufig diskutiert wird?", new[] { "Kurzfristige wirtschaftliche Interessen der Geberländer gegenüber den langfristigen Bedürfnissen der Empfängerländer", "Es gibt bei der Entwicklungspolitik grundsätzlich keinerlei Zielkonflikte, was die eigentliche Bedeutung des Begriffs verfehlt", "Geber- und Empfängerländer haben immer exakt identische Interessen" }, "Kurzfristige wirtschaftliche Interessen der Geberländer gegenüber den langfristigen Bedürfnissen der Empfängerländer",
        ...
        ("Was ist eine Kritik, die manchmal an internationaler Entwicklungshilfe geäußert wird?", new[] { "Sie könne in manchen Fällen Abhängigkeiten schaffen, statt eigenständige Entwicklung zu fördern", "Entwicklungshilfe wird niemals kritisch diskutiert", "Entwicklungshilfe hat historisch niemals irgendwelche Nebenwirkungen gehabt und deshalb hier nicht zutrifft" }, "Sie könne in manchen Fällen Abhängigkeiten schaffen, statt eigenständige Entwicklung zu fördern",
        ...
        ("Was ist ein Ziel der Vereinten Nationen mit den \"Nachhaltigkeitszielen\" (Sustainable Development Goals) im Bereich Frieden?", new[] { "Frieden, Gerechtigkeit und starke Institutionen weltweit zu fördern", "Ausschließlich wirtschaftliches Wachstum ohne jeden weiteren Bezug (was so in der Praxis nicht zutrifft)", "Die Abschaffung aller internationalen Organisationen" }, "Frieden, Gerechtigkeit und starke Institutionen weltweit zu fördern",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] EuropaeischeUnionListe =
    {
        ...
        ("Wie viele Unterschriften sind für eine erfolgreiche Europäische Bürgerinitiative ungefähr notwendig?", new[] { "Rund eine Million aus mehreren Mitgliedstaaten", "Nur 100 Unterschriften", "Über eine Milliarde Unterschriften, was so nicht korrekt ist" }, "Rund eine Million aus mehreren Mitgliedstaaten",
        ...
        ("Was ist mit der \"Finalität der EU\" (Bundesstaat vs. Staatenbund) gemeint?", new[] { "Die offene Frage, wie eng die politische Integration der EU langfristig werden soll", "Ein bereits abschließend entschiedenes, unveränderliches Ergebnis - eine haeufige, aber unzutreffende Vorstellung", "Ein Begriff, der ausschließlich die Wirtschaftspolitik betrifft" }, "Die offene Frage, wie eng die politische Integration der EU langfristig werden soll",
        ...
        ("Was ist ein Beispiel für praktische Partizipationsmöglichkeiten von EU-Bürgerinnen und -Bürgern neben Wahlen zum Europäischen Parlament?", new[] { "Die Nutzung der Europäischen Bürgerinitiative oder die Teilnahme an öffentlichen EU-Konsultationen", "EU-Bürgerinnen und -Bürger haben außerhalb von Wahlen keinerlei Mitwirkungsmöglichkeiten (was so in der Praxis nicht zutrifft)", "Nur nationale Regierungschefs dürfen sich an EU-Prozessen beteiligen" }, "Die Nutzung der Europäischen Bürgerinitiative oder die Teilnahme an öffentlichen EU-Konsultationen",
        ...
        ("Was ist der EU-Binnenmarkt?", new[] { "Ein gemeinsamer Wirtschaftsraum, in dem Waren, Dienstleistungen, Kapital und Personen sich weitgehend frei bewegen können", "Ein Markt, der ausschließlich für ein einziges Mitgliedsland gilt - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt", "Ein Begriff, der nur den Handel mit Nicht-EU-Ländern beschreibt" }, "Ein gemeinsamer Wirtschaftsraum, in dem Waren, Dienstleistungen, Kapital und Personen sich weitgehend frei bewegen können",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] ArmutReichtumPolitikListe =
    {
        ...
        ("Was ist der Mindestlohn?", new[] { "Der gesetzlich niedrigste Stundenlohn, den Arbeitgeber zahlen müssen", "Der höchste erlaubte Stundenlohn in Deutschland, obwohl das auf den ersten Blick plausibel klingt", "Ein freiwilliges Trinkgeld für Angestellte" }, "Der gesetzlich niedrigste Stundenlohn, den Arbeitgeber zahlen müssen",
            "Der Mindestlohn legt gesetzlich fest, wie wenig Arbeitgeber ihren Angestellten pro Stunde mindestens zahlen dürfen."),
        ("Was ist \"Kinderarmut\" in Deutschland?", new[] { "Wenn Kinder in Familien aufwachsen, die nur sehr wenig Geld zur Verfügung haben", "Ein anderes Wort für Kinderarbeit", "Ein Zustand, der in Deutschland gar nicht existiert, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Wenn Kinder in Familien aufwachsen, die nur sehr wenig Geld zur Verfügung haben",
        ...
        ("Was ist ein Beispiel für eine soziale Einrichtung, die Familien mit wenig Geld unterstützt?", new[] { "Zum Beispiel eine Suppenküche, Kleiderkammer oder ein Familienzentrum", "Ein privates Luxushotel", "Eine Bank für Wertpapierhandel, auch wenn das manche zunaechst vermuten wuerden" }, "Zum Beispiel eine Suppenküche, Kleiderkammer oder ein Familienzentrum",
            "Solche Einrichtungen bieten bedürftigen Familien praktische Unterstützung im Alltag, von Essen bis Kleidung."),
        ("Was versteht man unter \"Chancengleichheit\"?", new[] { "Alle Menschen sollen unabhängig von ihrer Herkunft die gleichen Möglichkeiten im Leben haben", "Nur reiche Menschen sollen gute Chancen bekommen", "Chancengleichheit bedeutet, dass alle exakt dasselbe Einkommen haben, was bei genauerem Hinsehen nicht stimmt" }, "Alle Menschen sollen unabhängig von ihrer Herkunft die gleichen Möglichkeiten im Leben haben",
        ...
        ("Was ist \"Elterngeld\"?", new[] { "Eine staatliche finanzielle Unterstützung für Eltern in der ersten Zeit nach der Geburt eines Kindes", "Ein Bonus, den Kinder direkt selbst erhalten, was einer genaueren Pruefung nicht standhaelt, obwohl das auf den ersten Blick plausibel klingt", "Eine Steuer auf die Geburt eines Kindes" }, "Eine staatliche finanzielle Unterstützung für Eltern in der ersten Zeit nach der Geburt eines Kindes",
            "Elterngeld unterstützt Eltern finanziell, wenn sie nach der Geburt eines Kindes weniger oder gar nicht arbeiten."),
        ("Warum gibt es in Deutschland eine gesetzliche Kranken- und Rentenversicherung?", new[] { "Damit alle Menschen im Krankheits- oder Rentenfall abgesichert sind, unabhängig vom eigenen Vermögen", "Damit nur reiche Menschen im Alter abgesichert sind, was die eigentliche Bedeutung des Begriffs verfehlt und deshalb hier nicht zutrifft", "Diese Versicherungen sind in Deutschland verboten" }, "Damit alle Menschen im Krankheits- oder Rentenfall abgesichert sind, unabhängig vom eigenen Vermögen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] GlobalisierteWeltListe =
    {
        ...
        ("Was ist ein Vorteil der Globalisierung?", new[] { "Menschen weltweit haben Zugang zu mehr Produkten, Wissen und Austausch", "Alle Länder sind dadurch komplett voneinander isoliert, was bei genauerem Hinsehen nicht stimmt", "Globalisierung hat ausschließlich Nachteile" }, "Menschen weltweit haben Zugang zu mehr Produkten, Wissen und Austausch",
        ...
        ("Was ist das Internet ein gutes Beispiel für in Bezug auf globale Vernetzung?", new[] { "Menschen weltweit können sich in Echtzeit austauschen und Informationen teilen", "Das Internet verbindet ausschließlich Menschen innerhalb eines Landes (was so in der Praxis nicht zutrifft)", "Das Internet hat mit Globalisierung nichts zu tun" }, "Menschen weltweit können sich in Echtzeit austauschen und Informationen teilen",
            "Das Internet ermöglicht sofortigen Austausch von Informationen und Kommunikation über Ländergrenzen hinweg."),
        ("Warum sprechen viele Menschen weltweit heute Englisch als gemeinsame Sprache?", new[] { "Englisch dient international oft als gemeinsame Verständigungssprache in Wirtschaft und Reisen", "Englisch ist die einzige Sprache, die weltweit gesetzlich erlaubt ist - eine verbreitete, aber falsche Annahme", "Alle anderen Sprachen der Welt sind ausgestorben" }, "Englisch dient international oft als gemeinsame Verständigungssprache in Wirtschaft und Reisen",
        ...
        ("Was können weltweite Handelsabkommen zwischen Ländern regeln?", new[] { "Zum Beispiel Zölle, Handelsregeln und wirtschaftliche Zusammenarbeit", "Ausschließlich die Farbe von Nationalflaggen, was einer genaueren Pruefung nicht standhaelt", "Sie regeln überhaupt nichts Konkretes" }, "Zum Beispiel Zölle, Handelsregeln und wirtschaftliche Zusammenarbeit",
            "Handelsabkommen legen fest, wie Länder wirtschaftlich zusammenarbeiten, z.B. bei Zöllen und Handelsbestimmungen."),
        ("Was ist ein Grund, warum manche Menschen Globalisierung kritisch sehen?", new[] { "Sie befürchten, dass lokale Kulturen, Arbeitsplätze oder Umweltstandards darunter leiden", "Kritiker befürchten zu wenig internationalen Handel", "Es gibt an der Globalisierung überhaupt keine Kritikpunkte, obwohl das auf den ersten Blick plausibel klingt" }, "Sie befürchten, dass lokale Kulturen, Arbeitsplätze oder Umweltstandards darunter leiden",
        ...
        ("Warum ist internationale Zusammenarbeit bei globalen Problemen wie dem Klimawandel wichtig?", new[] { "Weil solche Probleme nicht von einem einzelnen Land allein gelöst werden können", "Weil der Klimawandel nur ein einziges Land betrifft", "Internationale Zusammenarbeit ist bei globalen Problemen unnötig und deshalb hier nicht zutrifft" }, "Weil solche Probleme nicht von einem einzelnen Land allein gelöst werden können",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] MigrationPolitikListe =
    {
        ...
        ("Was bedeutet \"doppelte Staatsbürgerschaft\"?", new[] { "Eine Person besitzt gleichzeitig die Staatsangehörigkeit von zwei Ländern", "Eine Person hat gar keine Staatsangehörigkeit, obwohl das auf den ersten Blick plausibel klingt", "Ein Land hat zwei verschiedene Regierungen" }, "Eine Person besitzt gleichzeitig die Staatsangehörigkeit von zwei Ländern",
        ...
        ("Wer entscheidet in Deutschland letztlich über die Migrationspolitik?", new[] { "Die gewählten politischen Vertreterinnen und Vertreter in Bundestag und Regierung", "Ausschließlich internationale Konzerne", "Migrationspolitik wird per Losentscheid festgelegt, was die eigentliche Bedeutung des Begriffs verfehlt" }, "Die gewählten politischen Vertreterinnen und Vertreter in Bundestag und Regierung",
        ...
        ("Was bedeutet \"kommunale Integrationsarbeit\"?", new[] { "Maßnahmen von Städten und Gemeinden, um Zugewanderten das Ankommen vor Ort zu erleichtern", "Ein Verbot für Städte, sich um Migrationsthemen zu kümmern und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Ausschließlich internationale Verträge zwischen Staaten" }, "Maßnahmen von Städten und Gemeinden, um Zugewanderten das Ankommen vor Ort zu erleichtern",
            "Städte und Gemeinden unterstützen mit eigenen Angeboten - z.B. Beratung oder Sprachkursen - die Integration vor Ort."),
        ("Was ist ein Ausländerbeirat bzw. Migrationsrat in manchen Kommunen?", new[] { "Ein Gremium, das die Interessen von Migrantinnen und Migranten in der Kommunalpolitik vertritt", "Eine Behörde, die ausschließlich Reisepässe ausstellt - eine haeufige, aber unzutreffende Vorstellung, auch wenn das manche zunaechst vermuten wuerden", "Ein privater Verein ohne politische Funktion" }, "Ein Gremium, das die Interessen von Migrantinnen und Migranten in der Kommunalpolitik vertritt",
        ...
        ("Was bedeutet \"Diskriminierung\" im Zusammenhang mit Migration?", new[] { "Die ungerechte Benachteiligung von Menschen aufgrund ihrer Herkunft", "Eine besondere Förderung von Migrantinnen und Migranten, was bei genauerem Hinsehen nicht stimmt", "Ein anderes Wort für Einbürgerung" }, "Die ungerechte Benachteiligung von Menschen aufgrund ihrer Herkunft",
        ...
        ("Warum ist die Verteilung von Geflüchteten auf verschiedene Bundesländer politisch geregelt?", new[] { "Damit die Aufnahme und Versorgung gerecht auf ganz Deutschland verteilt wird", "Damit ausschließlich ein einziges Bundesland zuständig ist, was einer genaueren Pruefung nicht standhaelt", "Diese Verteilung ist gesetzlich nicht geregelt" }, "Damit die Aufnahme und Versorgung gerecht auf ganz Deutschland verteilt wird",
        ...
        ("Was bedeutet \"gesellschaftlicher Zusammenhalt\" im Zusammenhang mit Zuwanderung?", new[] { "Das friedliche und respektvolle Zusammenleben unterschiedlicher Bevölkerungsgruppen", "Die vollständige Trennung verschiedener Bevölkerungsgruppen, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Grenzkontrollen" }, "Das friedliche und respektvolle Zusammenleben unterschiedlicher Bevölkerungsgruppen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] RechtsstaatListe =
    {
        ...
        ("Warum sind Klassenregeln in der Schule ein kleines Beispiel für Rechtsstaatlichkeit?", new[] { "Sie gelten für alle gleichermaßen und sichern ein faires Miteinander", "Sie gelten nur für einzelne, ausgewählte Schülerinnen und Schüler, was die eigentliche Bedeutung des Begriffs verfehlt", "Klassenregeln haben mit Rechtsstaatlichkeit nichts zu tun" }, "Sie gelten für alle gleichermaßen und sichern ein faires Miteinander",
            "Wie Gesetze im Staat gelten Klassenregeln für alle gleichermaßen und sorgen für ein geordnetes, faires Miteinander."),
        ("Was sind Kinderrechte?", new[] { "Grundlegende Rechte, die speziell den Schutz und die Bedürfnisse von Kindern sichern", "Rechte, die ausschließlich Erwachsene betreffen und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Ein anderes Wort für Hausaufgaben" }, "Grundlegende Rechte, die speziell den Schutz und die Bedürfnisse von Kindern sichern",
        ...
        ("Was bedeutet \"Unschuldsvermutung\"?", new[] { "Eine Person gilt so lange als unschuldig, bis ihre Schuld gerichtlich bewiesen ist", "Jede angeklagte Person gilt automatisch als schuldig - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt", "Ein anderes Wort für Gewaltenteilung" }, "Eine Person gilt so lange als unschuldig, bis ihre Schuld gerichtlich bewiesen ist",
        ...
        ("Was ist eine Kinderbeauftragte bzw. ein Kinderbeauftragter?", new[] { "Eine Person oder Stelle, die sich besonders für die Rechte und Interessen von Kindern einsetzt", "Ein anderes Wort für Schulleitung", "Eine Person, die ausschließlich Prüfungen abnimmt, was die eigentliche Bedeutung des Begriffs verfehlt und deshalb hier nicht zutrifft" }, "Eine Person oder Stelle, die sich besonders für die Rechte und Interessen von Kindern einsetzt",
        ...
        ("Warum ist die Schulpflicht auch eine Umsetzung des Rechts auf Bildung?", new[] { "Sie stellt sicher, dass wirklich alle Kinder Zugang zu Bildung bekommen", "Sie verhindert, dass Kinder überhaupt lernen dürfen", "Schulpflicht hat mit dem Recht auf Bildung nichts zu tun, was so nicht korrekt ist" }, "Sie stellt sicher, dass wirklich alle Kinder Zugang zu Bildung bekommen",
            "Indem die Schulpflicht für alle Kinder gilt, wird das Recht auf Bildung praktisch für jedes Kind umgesetzt."),
        ("Was ist Kinderarbeit und warum ist sie in Deutschland weitgehend verboten?", new[] { "Arbeit von Kindern unter dem gesetzlichen Mindestalter - verboten, um Kindheit, Gesundheit und Bildung zu schützen", "Ein anderes Wort für Hausaufgaben", "Kinderarbeit ist in Deutschland ausdrücklich erlaubt und gefördert - eine haeufige, aber unzutreffende Vorstellung, auch wenn das manche zunaechst vermuten wuerden" }, "Arbeit von Kindern unter dem gesetzlichen Mindestalter - verboten, um Kindheit, Gesundheit und Bildung zu schützen",

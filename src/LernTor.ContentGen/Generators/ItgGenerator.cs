...
public sealed class ItgGenerator : ExerciseGeneratorBase
{
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] DatenschutzListe =
    {
        ...
        ("Warum ist Online-Banking oder Einkaufen über ein öffentliches, ungesichertes WLAN riskant?", new[] { "Daten können in offenen Netzwerken leichter von Dritten mitgelesen werden", "Öffentliches WLAN ist immer schneller", "Es gibt dabei überhaupt kein Risiko" },
        ...
        ("Was ist eine IP-Adresse, einfach erklärt?", new[] { "Eine Art Adresse, über die ein Gerät im Internet erreichbar ist", "Ein anderes Wort für Passwort", "Der Name eines Computerprogramms" },
        ...
        ("Was ist ein \"Datenleck\" (Datenpanne)?", new[] { "Wenn persönliche Daten unabsichtlich an Unbefugte gelangen", "Ein technischer Fachbegriff für einen leeren Akku", "Ein Programm zum Daten-Aufräumen" },
        ...
        ("Warum sollte man die Standort-Freigabe von Apps kritisch prüfen?", new[] { "Weil Apps sonst genau nachverfolgen können, wo man sich aufhält", "Weil das den Akku überhaupt nicht beeinflusst", "Weil Standortdaten gesetzlich verboten sind" },
        ...
        ("Was bedeutet das \"Recht auf Löschung\" (auch \"Recht auf Vergessenwerden\")?", new[] { "Man kann verlangen, dass ein Unternehmen die eigenen gespeicherten Daten löscht", "Man darf keine eigenen Fotos mehr posten", "Firmen dürfen niemals Daten speichern" },
        ...
        ("Was sind biometrische Daten?", new[] { "Körperliche Merkmale wie Fingerabdruck oder Gesicht, die zur Identifikation genutzt werden", "Daten über Lieblingsspiele", "Die Anzahl der Kontakte im Handy" },
        ...
        ("Was verfolgen viele Werbe-Tracker beim Surfen im Internet?", new[] { "Welche Webseiten man besucht, um passende Werbung zu zeigen", "Nur die Uhrzeit des letzten Neustarts", "Die Anzahl der installierten Schriftarten" },
        ...
        ("Warum ist es sinnvoll, bei unwichtigen Spiele-Apps nicht automatisch das echte Geburtsdatum anzugeben?", new[] { "Weniger echte persönliche Daten im Umlauf verringern das Risiko bei einem Datenleck", "Weil Apps ohne Geburtsdatum gar nicht funktionieren", "Weil das gesetzlich vorgeschrieben ist" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] PasswortListe =
    {
        ...
        ("Was ist ein Passwort-Manager?", new[] { "Ein Programm, das sichere Passwörter erstellt und verschlüsselt speichert", "Ein Mitarbeiter, der Passwörter für andere errät", "Ein Ordner auf dem Schreibtisch" },
        ...
        ("Warum ist \"MeineKatzeMauzi1990\" riskant, wenn viele Menschen dein Haustier und Geburtsjahr kennen?", new[] { "Weil persönliche Infos leicht zu erraten sind, wenn man dich kennt", "Weil das Passwort zu lang ist", "Weil Katzennamen grundsätzlich verboten sind" },
        ...
        ("Was ist eine \"Passphrase\"?", new[] { "Ein langes Passwort aus mehreren zufälligen Wörtern, leicht zu merken, schwer zu erraten", "Ein Passwort, das man laut aussprechen muss", "Ein anderes Wort für PIN-Code" },
        ...
        ("Was bedeutet es, wenn eine Webseite meldet, ein Konto sei in einem bekannten \"Datenleck\" aufgetaucht?", new[] { "Das Passwort dieses Kontos sollte umgehend geändert werden", "Man kann die Meldung ignorieren", "Das Konto wird automatisch gelöscht" },
        ...
        ("Wo sollte man ein aufgeschriebenes Passwort auf keinen Fall aufbewahren?", new[] { "Auf einem Klebezettel direkt am Bildschirm", "In einem verschlossenen Passwort-Manager", "Nur im eigenen Kopf" },
        ...
        ("Was ist ein \"Wörterbuchangriff\" auf ein Passwort?", new[] { "Automatisches Ausprobieren gängiger Wörter und bekannter Passwörter", "Das Nachschlagen eines Wortes im echten Wörterbuch", "Ein Rechtschreibprogramm" },
        ...
        ("Was ist ein guter Trick, um sich ein langes, sicheres Passwort trotzdem merken zu können?", new[] { "Einen ungewöhnlichen Satz merken und daraus Anfangsbuchstaben plus Zahlen/Sonderzeichen bilden", "Das Passwort möglichst kurz halten", "Immer dasselbe einfache Wort verwenden" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] UrheberrechtListe =
    {
        ...
        ("Was bedeutet \"gemeinfrei\" (Public Domain) bei einem Werk?", new[] { "Das Werk darf von jedem frei genutzt werden, meist weil der Schutz abgelaufen ist", "Das Werk gehört einer einzigen Firma", "Das Werk darf niemand jemals anschauen" },
        ...
        ("Was bedeutet \"Plagiat\"?", new[] { "Fremde Werke oder Texte als eigene ausgeben, ohne Quelle zu nennen", "Ein besonders kreatives eigenes Werk", "Ein Fachbegriff für ein Musikinstrument" },
        ...
        ("Warum ist das Streamen eines Films über eine illegale, nicht lizenzierte Streaming-Seite problematisch?", new[] { "Es kann eine Urheberrechtsverletzung sein und schadet den Rechteinhabern finanziell", "Es ist völlig ohne rechtliche Bedeutung", "Filme unterliegen grundsätzlich keinem Urheberrecht" },
        ...
        ("Darf man ganze Schulbücher einscannen und frei im Internet teilen?", new[] { "Nein, das verletzt in der Regel das Urheberrecht des Verlags", "Ja, Schulbücher sind immer gemeinfrei", "Nur an Wochenenden erlaubt" },
        ...
        ("Ist selbst geschriebener Programmcode urheberrechtlich geschützt?", new[] { "Ja, auch Software fällt unter das Urheberrecht", "Nein, Code ist grundsätzlich frei nutzbar", "Nur wenn er länger als 1000 Zeilen ist" },
        ...
        ("Darf man ein fremdes Firmenlogo einfach für ein eigenes Schulprojekt-Plakat verwenden?", new[] { "Nur mit Erlaubnis oder passender Lizenz", "Ja, Logos sind grundsätzlich frei", "Nur wenn das Plakat größer als A4 ist" },
        ...
        ("Was ist der Unterschied zwischen Urheberrecht und Markenrecht (vereinfacht)?", new[] { "Urheberrecht schützt Werke wie Texte/Bilder, Markenrecht schützt Namen/Logos von Unternehmen", "Beide bedeuten exakt dasselbe", "Markenrecht gilt nur für Kleidung" },
        ...
        ("Warum reicht \"Ich habe das Bild bei Google gefunden\" nicht als Erlaubnis, es zu nutzen?", new[] { "Google zeigt nur Bilder an, ist aber nicht der Rechteinhaber", "Google-Bilder sind immer automatisch gemeinfrei", "Bilder aus Suchmaschinen unterliegen keinem Urheberrecht" },
        ...
        ("Was kann eine mögliche Folge einer schweren Urheberrechtsverletzung sein?", new[] { "Eine kostenpflichtige Abmahnung oder rechtliche Konsequenzen", "Ein Lob vom Urheber", "Gar keine Konsequenzen sind möglich" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] CybermobbingListe =
    {
        ...
        ("Was unterscheidet einen normalen Streit von echtem Cybermobbing?", new[] { "Cybermobbing ist wiederholt und oft mit einem Machtungleichgewicht verbunden", "Bei Cybermobbing lachen am Ende alle Beteiligten", "Es gibt keinen Unterschied"},
        ...
        ("Warum reicht das bloße Blockieren einer mobbenden Person manchmal nicht aus?", new[] { "Weil die Person mit einem anderen oder gefälschten Konto weitermachen könnte", "Weil Blockieren technisch gar nicht möglich ist", "Weil Blockieren die Situation immer sofort komplett löst" },
        ...
        ("Was können psychische Folgen von Cybermobbing für Betroffene sein?", new[] { "Angst, Traurigkeit und sozialer Rückzug", "Ausschließlich positive Gefühle", "Keinerlei Auswirkungen" },
        ...
        ("Was kann eine beobachtende Person aktiv gegen Cybermobbing tun?", new[] { "Der betroffenen Person offen Unterstützung zeigen und Erwachsene informieren", "Einfach weiterscrollen und nichts sagen", "Selbst noch einen gemeinen Kommentar dazuschreiben" },
        ...
        ("Dürfen peinliche Fotos einer Mitschülerin/eines Mitschülers ohne deren Erlaubnis in einer Chatgruppe geteilt werden?", new[] { "Nein, das kann rechtliche und emotionale Folgen haben", "Ja, wenn das Foto lustig genug ist", "Nur wenn mehr als 10 Personen in der Gruppe sind" },
        ...
        ("Was ist ein \"Hasskommentar\"?", new[] { "Eine beleidigende, oft anonyme Nachricht mit dem Ziel, jemanden herabzuwürdigen", "Ein besonders konstruktiver Verbesserungsvorschlag", "Ein Kommentar mit vielen Likes" },
        ...
        ("Warum fühlen sich manche Menschen im Internet 'sicherer', jemanden zu beleidigen, als sie es im echten Leben täten?", new[] { "Weil die scheinbare Anonymität und fehlende direkte Reaktion Hemmungen abbauen", "Weil das Internet Beleidigungen automatisch verbietet", "Weil online geschriebene Worte keine Wirkung haben" },
        ...
        ("Was sollte man tun, wenn man selbst versehentlich an einer gemeinen Aktion gegen jemanden beteiligt war?", new[] { "Sich entschuldigen und das eigene Verhalten stoppen", "So tun, als sei nichts passiert", "Die Schuld komplett auf andere schieben" },
        ...
        ("Was ist ein sinnvoller erster Schritt für Eltern oder Lehrkräfte, wenn ein Kind von Cybermobbing berichtet?", new[] { "Ernst nehmen, zuhören und gemeinsam nach Lösungen suchen", "Das Handy sofort und ohne Gespräch wegnehmen", "Die Sache herunterspielen, das wird schon vergehen" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] FakeNewsListe =
    {
        ...
        ("Was bedeutet \"Clickbait\"?", new[] { "Eine reißerische Überschrift, die vor allem zum Klicken verleiten soll", "Ein technischer Fachbegriff für schnelles Internet", "Ein Programm zum Sortieren von Nachrichten" },
        ...
        ("Warum verbreiten sich Falschmeldungen im Internet oft schneller als spätere Richtigstellungen?", new[] { "Weil emotionale, aufregende Inhalte häufiger geteilt werden als nüchterne Korrekturen", "Weil Richtigstellungen gesetzlich verboten sind", "Weil Falschmeldungen immer kürzer sind" },
        ...
        ("Was kann man tun, um herauszufinden, ob ein Foto zu einer Nachricht schon einmal in einem anderen Zusammenhang genutzt wurde?", new[] { "Eine umgekehrte Bildersuche im Internet durchführen", "Das Bild einfach größer zoomen", "Die Helligkeit des Bildes verändern" },
        ...
        ("Warum sollte man eine wichtige Behauptung, die nur auf eine anonyme Quelle ohne Namen gestützt ist, kritisch sehen?", new[] { "Weil man die Glaubwürdigkeit einer namenlosen Quelle schwerer einschätzen kann", "Weil anonyme Quellen immer lügen", "Weil Namen bei Nachrichten grundsätzlich unwichtig sind" },
        ...
        ("Was bedeutet \"Verifizierung\" einer Nachricht?", new[] { "Die Überprüfung, ob eine Information wirklich stimmt, z.B. durch mehrere unabhängige Quellen", "Das Löschen einer Nachricht", "Das Übersetzen einer Nachricht in eine andere Sprache" },
        ...
        ("Warum können auch gutgemeinte Weiterleitungen von Familienmitgliedern in Chatgruppen Falschinformationen verbreiten?", new[] { "Weil auch sie oft ungeprüfte Inhalte teilen, ohne die Quelle zu checken", "Weil Familienmitglieder nie Fehler machen", "Weil Chatgruppen automatisch alle Inhalte prüfen" },
        ...
        ("Was ist ein \"Bot\" im Zusammenhang mit der Verbreitung von Falschnachrichten?", new[] { "Ein automatisiertes Programm, das massenhaft Inhalte postet oder teilt", "Ein besonders vertrauenswürdiger Nutzer-Account", "Ein Fachbegriff für einen Zeitungsjournalisten" },
        ...
        ("Warum reicht eine hohe Anzahl an Likes oder Shares eines Beitrags NICHT als Beweis für dessen Wahrheit?", new[] { "Weil auch falsche Inhalte sich sehr schnell und weit verbreiten können", "Weil Likes automatisch nur bei wahren Inhalten vergeben werden", "Weil Likes von einer Regierungsbehörde geprüft werden" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] AlgorithmenListe =
    {
        ...
        ("Was bedeutet \"künstliche Intelligenz\" im Unterschied zu einem einfachen, festen Algorithmus (vereinfacht)?", new[] { "KI kann aus Daten lernen und sich anpassen, ein einfacher Algorithmus folgt immer denselben festen Schritten", "Beide Begriffe bedeuten exakt dasselbe", "KI ist ein anderes Wort für Hardware" },
        ...
        ("Warum zeigt eine Videoplattform nach einem Video oft ein sehr ähnliches als Nächstes an?", new[] { "Der Algorithmus versucht, Zuschauende möglichst lange auf der Plattform zu halten", "Es ist reiner Zufall", "Jedes Video wird zufällig neu sortiert" },
        ...
        ("Warum kann ein Algorithmus, der mit unfairen Trainingsdaten trainiert wurde, diskriminierende Ergebnisse liefern?", new[] { "Weil er die Muster und Vorurteile aus den Trainingsdaten übernimmt", "Weil Algorithmen absichtlich böse programmiert werden", "Weil das technisch unmöglich ist" },
        ...
        ("Was ist ein einfaches Beispiel für einen Algorithmus im Alltag, ganz ohne Computer?", new[] { "Ein Kochrezept mit genauen Schritten", "Ein zufälliges Gefühl", "Eine Emotion wie Freude" },
        ...
        ("Was bedeutet \"Personalisierung\" bei Online-Diensten?", new[] { "Inhalte werden individuell an das bisherige Verhalten einer Person angepasst", "Alle Nutzer sehen exakt dieselben Inhalte", "Eine Webseite wird für jeden zufällig neu programmiert" },
        ...
        ("Warum kann starke Personalisierung von Inhalten problematisch sein?", new[] { "Weil man dadurch seltener andere Sichtweisen oder Themen zu sehen bekommt", "Weil personalisierte Inhalte immer falsch sind", "Weil das technisch gar nicht funktioniert" },
        ...
        ("Was ist ein \"Chatbot\"?", new[] { "Ein Programm, das mithilfe von Algorithmen automatisch auf Textnachrichten antwortet", "Ein menschlicher Kundenservice-Mitarbeiter", "Ein Computerspiel-Charakter ohne Programmierung" },
        ...
        ("Wofür wird ein Algorithmus bei einer Navigations-App genutzt?", new[] { "Um aus vielen möglichen Wegen den schnellsten/besten zu berechnen", "Um das Wetter vorherzusagen", "Um Musik abzuspielen" },
        ...
        ("Was bedeutet es, wenn eine App \"lernt\", welche Inhalte dir gefallen?", new[] { "Sie wertet dein bisheriges Verhalten (Klicks, Likes) aus, um Vorschläge anzupassen", "Die App liest heimlich deine Gedanken", "Die App fragt dich jeden Tag persönlich" },
        ...
        ("Warum ist völlige Neutralität bei jedem Algorithmus schwer zu garantieren?", new[] { "Weil Menschen die Regeln/Daten festlegen und dabei eigene Annahmen einfließen", "Weil Algorithmen von Natur aus perfekt objektiv sind", "Weil Computer keine Fehler machen können" },

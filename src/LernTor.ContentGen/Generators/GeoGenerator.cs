...
public sealed class GeoGenerator : ExerciseGeneratorBase
{
    ...
    {
        ("Was sind fossile Energieträger?", new[] { "Über Jahrmillionen aus abgestorbenen Lebewesen entstandene Rohstoffe wie Kohle, Erdöl und Erdgas", "Ausschließlich Sonnen- und Windenergie", "Nur Wasserkraft" }, "Über Jahrmillionen aus abgestorbenen Lebewesen entstandene Rohstoffe wie Kohle, Erdöl und Erdgas",
        ...
        ("Warum gelten fossile Energieträger als nicht erneuerbar?", new[] { "Ihre Neubildung dauert Jahrmillionen, viel länger als der menschliche Verbrauch", "Sie bilden sich innerhalb weniger Tage neu", "Sie sind in unbegrenzter Menge vorhanden" }, "Ihre Neubildung dauert Jahrmillionen, viel länger als der menschliche Verbrauch",
        ...
        ("Was sind erneuerbare Energien?", new[] { "Energiequellen wie Sonne, Wind und Wasser, die sich ständig neu erneuern", "Ausschließlich Kohle und Erdöl", "Nur Kernenergie" }, "Energiequellen wie Sonne, Wind und Wasser, die sich ständig neu erneuern",
        ...
        ("Was sind \"Seltene Erden\"?", new[] { "Eine Gruppe von Metallen, die u.a. für Smartphones und Elektronik wichtig sind", "Ein anderes Wort für fossile Brennstoffe", "Eine Bezeichnung für besonders fruchtbaren Ackerboden" }, "Eine Gruppe von Metallen, die u.a. für Smartphones und Elektronik wichtig sind",
        ...
        ("Was ist eine \"globale Stoffstromanalyse\" bei einem Produkt wie einem Smartphone?", new[] { "Die Untersuchung, woher die Rohstoffe stammen und wie sie um die Welt transportiert werden", "Eine Analyse, die sich nur mit dem Verkaufspreis befasst", "Ein Begriff, der nur für Lebensmittel verwendet wird" }, "Die Untersuchung, woher die Rohstoffe stammen und wie sie um die Welt transportiert werden",
        ...
        ("Was ist ein möglicher Grund für Konflikte zwischen Industrienationen und Förderländern beim Abbau fossiler Energieträger?", new[] { "Ungleiche Verteilung von Gewinnen, Umweltschäden und politischer Einfluss auf die Förderregionen", "Es gibt bei fossilen Rohstoffen grundsätzlich keinerlei Konfliktpotenzial", "Förderländer erhalten immer den größten Teil der Gewinne" }, "Ungleiche Verteilung von Gewinnen, Umweltschäden und politischer Einfluss auf die Förderregionen",
        ...
        ("Was ist ein Vorteil von Windkraft als Energiequelle?", new[] { "Sie verursacht bei der Stromerzeugung selbst keine CO₂-Emissionen", "Sie ist nur begrenzt oft nutzbar wie fossile Brennstoffe", "Sie verursacht besonders viel CO₂" }, "Sie verursacht bei der Stromerzeugung selbst keine CO₂-Emissionen",
        ...
        ("Warum wird der Ausbau erneuerbarer Energien oft als wichtiger Beitrag zum Klimaschutz gesehen?", new[] { "Sie ersetzen fossile Energieträger und senken so den CO₂-Ausstoß", "Sie erhöhen den CO₂-Ausstoß im Vergleich zu Kohle deutlich", "Sie haben mit dem Klimaschutz nichts zu tun" }, "Sie ersetzen fossile Energieträger und senken so den CO₂-Ausstoß",
        ...
        ("Welche Rolle spielt Kobalt bei der Produktion von Smartphone- und Elektroauto-Akkus?", new[] { "Es ist ein wichtiger Rohstoff für Batterien, dessen Abbau oft mit schwierigen Arbeitsbedingungen verbunden ist", "Kobalt spielt bei Batterien überhaupt keine Rolle", "Kobalt wird ausschließlich in Europa gefördert" }, "Es ist ein wichtiger Rohstoff für Batterien, dessen Abbau oft mit schwierigen Arbeitsbedingungen verbunden ist",
        ...
        ("Was zeigt ein Wirkungsgefüge (Ursache-Folge-Diagramm) beim Thema globaler Rohstoffabbau?", new[] { "Wie wirtschaftliche, soziale und ökologische Faktoren miteinander zusammenhängen", "Ausschließlich die geografische Lage eines Rohstoffvorkommens", "Nur den Verkaufspreis eines Rohstoffs" }, "Wie wirtschaftliche, soziale und ökologische Faktoren miteinander zusammenhängen",
        ...
        ("Was kann eine Diversifizierung der Energiequellen (z.B. Mix aus Wind, Sonne, Wasser) für die Versorgungssicherheit eines Landes bedeuten?", new[] { "Weniger Abhängigkeit von einer einzigen Energiequelle oder einem einzigen Lieferland", "Eine größere Abhängigkeit von einem einzigen fossilen Energieträger", "Keinerlei Unterschied zur Nutzung nur einer Energiequelle" }, "Weniger Abhängigkeit von einer einzigen Energiequelle oder einem einzigen Lieferland",
        ...
        ("Was zeigt sich, wenn man die weltweite Verteilung von Erdölvorkommen betrachtet?", new[] { "Sie ist geografisch sehr ungleich verteilt, mit großen Vorkommen z.B. im Nahen Osten", "Erdöl ist überall auf der Welt in exakt gleicher Menge vorhanden", "Erdöl kommt ausschließlich in Europa vor" }, "Sie ist geografisch sehr ungleich verteilt, mit großen Vorkommen z.B. im Nahen Osten",
            "Erdölvorkommen sind weltweit sehr ungleich verteilt, mit besonders großen bekannten Reserven u.a. im Nahen Osten."),
        ("Warum wird beim Rohstoffabbau zunehmend auf Recycling (z.B. von Elektroschrott) gesetzt?", new[] { "Um wertvolle Rohstoffe wiederzuverwenden und den Bedarf an neuem Abbau zu senken", "Weil recycelte Rohstoffe grundsätzlich wertlos sind", "Weil Recycling den Rohstoffbedarf immer erhöht" }, "Um wertvolle Rohstoffe wiederzuverwenden und den Bedarf an neuem Abbau zu senken",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] LandwirtschaftBodenListe =
    {
        ...
        ("Was bedeutet \"Ressourcenschonung\" in der Landwirtschaft?", new[] { "Böden, Wasser und andere natürliche Ressourcen so nutzen, dass sie langfristig erhalten bleiben", "Möglichst viele Ressourcen auf einmal verbrauchen", "Ressourcen nur einmalig zu nutzen, ohne auf die Zukunft zu achten" }, "Böden, Wasser und andere natürliche Ressourcen so nutzen, dass sie langfristig erhalten bleiben",
        ...
        ("Warum wird eine nachhaltige Forstwirtschaft angestrebt?", new[] { "Damit nicht mehr Holz eingeschlagen wird, als nachwachsen kann", "Damit möglichst schnell der gesamte Wald abgeholzt wird", "Weil Holz keine begrenzte Ressource ist" }, "Damit nicht mehr Holz eingeschlagen wird, als nachwachsen kann",
        ...
        ("Was ist ein Vorteil des ökologischen Landbaus für die Artenvielfalt?", new[] { "Er bietet durch den Verzicht auf chemische Pestizide oft mehr Lebensraum für Insekten und andere Tiere", "Er verringert die Artenvielfalt grundsätzlich", "Er hat keinerlei Auswirkung auf die Artenvielfalt" }, "Er bietet durch den Verzicht auf chemische Pestizide oft mehr Lebensraum für Insekten und andere Tiere",
        ...
        ("Was zeigt eine thematische Karte zur globalen Waldbedeckung typischerweise?", new[] { "Wo auf der Welt Waldflächen zu- oder abgenommen haben", "Nur die politischen Ländergrenzen", "Ausschließlich die Bevölkerungsdichte eines Landes" }, "Wo auf der Welt Waldflächen zu- oder abgenommen haben",
        ...
        ("Was ist ein Grund für globale Überfischung mancher Fischbestände?", new[] { "Hohe weltweite Nachfrage kombiniert mit zu intensiver, wenig regulierter Fischerei", "Zu geringe weltweite Nachfrage nach Fisch", "Fischbestände erneuern sich immer schneller als sie gefangen werden" }, "Hohe weltweite Nachfrage kombiniert mit zu intensiver, wenig regulierter Fischerei",
        ...
        ("Was können Fangquoten für die Fischerei bewirken?", new[] { "Sie sollen die Menge gefangener Fische begrenzen, um Bestände zu schützen", "Sie erhöhen die gefangene Fischmenge unbegrenzt", "Sie haben keinerlei Einfluss auf Fischbestände" }, "Sie sollen die Menge gefangener Fische begrenzen, um Bestände zu schützen",
        ...
        ("Was ist ein Beispiel für nachhaltige Fischerei?", new[] { "Fischfang, der sich an wissenschaftlich ermittelten Fangquoten orientiert", "Fischfang ohne jede Begrenzung der Fangmenge", "Der vollständige Verzicht auf jegliche Fischerei weltweit" }, "Fischfang, der sich an wissenschaftlich ermittelten Fangquoten orientiert",
    ...
    {
        ("Was ist ein Ziel internationaler Klimaschutzmaßnahmen?", new[] { "Den Ausstoß von Treibhausgasen weltweit zu verringern", "Den Ausstoß von Treibhausgasen möglichst zu erhöhen", "Fossile Energieträger unbegrenzt zu fördern" }, "Den Ausstoß von Treibhausgasen weltweit zu verringern",
        ...
        ("Was ist eine Aufgabe von Mediation bei internationalen Klimakonflikten?", new[] { "Zwischen unterschiedlichen Interessen (z.B. Industrienationen und Schwellenländern) zu vermitteln", "Ausschließlich eine Konfliktseite zu bevorzugen", "Klimakonflikte vollständig zu ignorieren" }, "Zwischen unterschiedlichen Interessen (z.B. Industrienationen und Schwellenländern) zu vermitteln",
        ...
        ("Was ist eine mögliche Klimaschutzmaßnahme auf staatlicher Ebene?", new[] { "Förderung erneuerbarer Energien und CO₂-Bepreisung", "Die unbegrenzte Förderung fossiler Brennstoffe", "Der komplette Verzicht auf jede Klimapolitik" }, "Förderung erneuerbarer Energien und CO₂-Bepreisung",
    ...
    {
        ("Was bedeutet \"Globalisierung\" in der Wirtschaftsgeografie?", new[] { "Die zunehmende weltweite Vernetzung von Handel, Produktion und Kommunikation", "Der vollständige Rückzug aller Länder aus dem internationalen Handel", "Ein Begriff, der ausschließlich den Tourismus betrifft" }, "Die zunehmende weltweite Vernetzung von Handel, Produktion und Kommunikation",
        ...
        ("Was versteht man unter \"Destinationsgebieten\" im Tourismus?", new[] { "Die beliebten Reiseziele, die von Touristen besucht werden", "Die Herkunftsländer der meisten Reisenden", "Ein anderes Wort für Flughäfen" }, "Die beliebten Reiseziele, die von Touristen besucht werden",
        ...
        ("Was ist ein Beispiel für den Wandel lokaler Wirtschaftsstandorte durch Globalisierung?", new[] { "Traditionelle Industriestandorte verlieren an Bedeutung, während neue Standorte (z.B. in Asien) wachsen", "Wirtschaftsstandorte verändern sich durch Globalisierung grundsätzlich nie", "Alle Wirtschaftsstandorte weltweit entwickeln sich immer exakt identisch" }, "Traditionelle Industriestandorte verlieren an Bedeutung, während neue Standorte (z.B. in Asien) wachsen",
        ...
        ("Was ist ein Grund, warum manche Regionen besonders stark vom internationalen Tourismus wirtschaftlich abhängig sind?", new[] { "Der Tourismussektor bietet dort einen Großteil der verfügbaren Arbeitsplätze und Einnahmen", "Tourismus spielt in solchen Regionen wirtschaftlich überhaupt keine Rolle", "Diese Regionen haben zahlreiche andere, ebenso starke Wirtschaftszweige" }, "Der Tourismussektor bietet dort einen Großteil der verfügbaren Arbeitsplätze und Einnahmen",
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] EuropaWirtschaftsraumListe =
    {
        ...
        ("Was zeigt eine thematische Karte zur Arbeitslosigkeit in Europa typischerweise?", new[] { "Regionale Unterschiede in der Arbeitslosenquote zwischen verschiedenen europäischen Regionen", "Ausschließlich die Bevölkerungsdichte", "Nur die Anzahl der Nationalparks" }, "Regionale Unterschiede in der Arbeitslosenquote zwischen verschiedenen europäischen Regionen",
        ...
        ("Was ist der Alpenraum als Region grenzübergreifender Zusammenarbeit?", new[] { "Ein Gebirgsraum, der sich über mehrere Länder wie Österreich, die Schweiz, Italien und Frankreich erstreckt", "Eine Region, die vollständig innerhalb eines einzigen Landes liegt", "Ein anderes Wort für den Ostseeraum" }, "Ein Gebirgsraum, der sich über mehrere Länder wie Österreich, die Schweiz, Italien und Frankreich erstreckt",
        ...
        ("Was zeigt eine räumliche Orientierung anhand topografischer Karten über naturräumliche Vielfalt Europas?", new[] { "Wo Gebirge, Tiefebenen, Küsten und Flüsse in Europa liegen", "Ausschließlich die Verteilung von Sprachgruppen", "Nur die Grenzen der Eurozone" }, "Wo Gebirge, Tiefebenen, Küsten und Flüsse in Europa liegen",
        ...
        ("Was ist ein Beispiel für soziale Disparitäten innerhalb Europas?", new[] { "Unterschiede beim Zugang zu Bildung, Gesundheitsversorgung oder Einkommen zwischen Regionen", "Ein Zustand, in dem alle Menschen in Europa exakt gleich viel verdienen", "Ein Begriff, der ausschließlich das Klima betrifft" }, "Unterschiede beim Zugang zu Bildung, Gesundheitsversorgung oder Einkommen zwischen Regionen",
        ...
        ("Was ist ein Beispiel für ökologische Disparitäten innerhalb Europas?", new[] { "Unterschiedlich starke Umweltbelastungen oder unterschiedlicher Ausbau erneuerbarer Energien je nach Region", "Ein Zustand, in dem alle Regionen exakt dieselbe Umweltqualität haben", "Ein Begriff, der nur für außereuropäische Länder gilt" }, "Unterschiedlich starke Umweltbelastungen oder unterschiedlicher Ausbau erneuerbarer Energien je nach Region",
        ...
        ("Was versteht man unter dem Konzept der \"multiperspektivischen\" Diskussion von EU-Chancen und -Herausforderungen?", new[] { "Verschiedene Sichtweisen (z.B. wirtschaftlich, politisch, regional) gleichberechtigt zu berücksichtigen", "Ausschließlich eine einzige, feste Sichtweise als allein gültig zu betrachten", "Ein Begriff, der mit der EU nichts zu tun hat" }, "Verschiedene Sichtweisen (z.B. wirtschaftlich, politisch, regional) gleichberechtigt zu berücksichtigen",
        ...
        ("Was ist ein Beispiel für eine naturräumliche Herausforderung, die mehrere europäische Länder gemeinsam betrifft?", new[] { "Der Schutz der Meeresumwelt in einem gemeinsamen Meeresraum wie der Ostsee", "Ein Naturraum, der ausschließlich innerhalb eines einzigen Landes liegt", "Ein Thema, das keinerlei Länder gemeinsam betrifft" }, "Der Schutz der Meeresumwelt in einem gemeinsamen Meeresraum wie der Ostsee",

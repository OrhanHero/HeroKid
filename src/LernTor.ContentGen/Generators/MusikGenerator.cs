...
public sealed class MusikGenerator : ExerciseGeneratorBase
{
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] GrundlagenDerMusikListe =
    {
        ...
        ("Wie viele Halbtonschritte umfasst eine Oktave im westlichen Tonsystem?", new[] { "12", "7 (was so in der Praxis nicht zutrifft)", "8" },
            "12", "Eine Oktave ist im westlichen (chromatischen) Tonsystem in 12 gleich große Halbtonschritte unterteilt."),
        ("Was ist eine Tonleiter?", new[] { "Eine festgelegte Abfolge von Tönen in aufsteigender oder absteigender Reihenfolge", "Ein einzelner, isolierter Ton", "Ein Begriff aus der Notation von Rhythmen - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Was ist charakteristisch für den Aufbau einer Dur-Tonleiter?", new[] { "Eine feste Abfolge von Ganz- und Halbtonschritten (Halbtonschritte zwischen 3./4. und 7./8. Stufe)", "Es gibt keinerlei feste Abfolge, Dur-Tonleitern sind beliebig aufgebaut, obwohl das auf den ersten Blick plausibel klingt", "Sie besteht ausschließlich aus Halbtonschritten" },
        ...
        ("Was bewirkt ein Vorzeichen (z.B. Kreuz oder b) vor einer Note?", new[] { "Es verändert die Tonhöhe der Note um einen Halbtonschritt", "Es verändert die Lautstärke der Note", "Es verändert ausschließlich die Notenlänge, was die eigentliche Bedeutung des Begriffs verfehlt" },
        ...
        ("Zu welcher Instrumentengruppe gehört die Gitarre?", new[] { "Zu den Saiteninstrumenten (Zupfinstrumente)", "Zu den Blechblasinstrumenten und deshalb hier nicht zutrifft", "Zu den Schlaginstrumenten" },
        ...
        ("Was zeigt die Notation von Tonhöhen im Notensystem?", new[] { "Auf welcher Linie oder im welchem Zwischenraum eine Note steht, bestimmt ihre Tonhöhe", "Ausschließlich die Lautstärke eines Tons, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Ausschließlich das verwendete Instrument" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] FormUndGestaltungListe =
    {
        ...
        ("Was bedeutet \"Komponieren mit Rhythmusbausteinen\"?", new[] { "Ein Musikstück aus vorgegebenen, kurzen rhythmischen Mustern zusammenzusetzen", "Ein Musikstück ausschließlich aus einem einzigen, langen Ton zu bilden, auch wenn das manche zunaechst vermuten wuerden", "Ein Begriff, der nur bei elektronischer Musik verwendet wird" },
        ...
        ("Was bedeutet \"Zweistimmigkeit\"?", new[] { "Zwei voneinander unabhängige, gleichzeitig erklingende Melodiestimmen", "Nur eine einzige Melodiestimme ohne Begleitung", "Ein Musikstück, das ausschließlich instrumental ist, was bei genauerem Hinsehen nicht stimmt" },
        ...
        ("Was ist ein Rondo?", new[] { "Eine musikalische Form, bei der ein wiederkehrender Hauptteil (Refrain) mit wechselnden Zwischenteilen (Couplets) abwechselt", "Eine Form, die aus nur einem einzigen Teil besteht (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt", "Ein anderes Wort für eine Tonleiter" },
        ...
        ("Was unterscheidet Solo von Tutti?", new[] { "Solo bedeutet, dass eine einzelne Person spielt, Tutti bedeutet, dass alle gemeinsam spielen", "Beide Begriffe bezeichnen exakt dasselbe, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt", "Tutti bedeutet, dass niemand spielt" },
        ...
        ("Was bedeutet \"Vorspiel\" in einem Musikstück?", new[] { "Ein einleitender Abschnitt vor dem eigentlichen Hauptteil des Stücks", "Der letzte, abschließende Teil eines Stücks und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Ein anderes Wort für eine Pause" },
        ...
        ("Was bedeutet \"Zusammenspiel\" (Ensemble-Spiel)?", new[] { "Mehrere Musiker:innen spielen aufeinander abgestimmt gemeinsam ein Stück", "Nur eine einzelne Person spielt komplett allein", "Ein Begriff, der ausschließlich beim Singen verwendet wird - eine haeufige, aber unzutreffende Vorstellung" },
        ...
        ("Wie ist ein Rondo typischerweise strukturell aufgebaut?", new[] { "Ein wiederkehrender Refrain wechselt sich mit unterschiedlichen Couplets ab, z.B. A-B-A-C-A", "Es besteht aus nur einem einzigen, unveränderlichen Teil, auch wenn das manche zunaechst vermuten wuerden", "Es hat immer exakt zwei gleich lange Teile" },
        ...
        ("Was bedeutet die Wiederholung des A-Teils am Ende einer ABA-Form?", new[] { "Der Anfangsteil kehrt nach dem kontrastierenden Mittelteil zurück und rundet das Stück ab", "Der A-Teil wird komplett übersprungen", "Der A-Teil wird beim zweiten Mal völlig verändert gespielt, was bei genauerem Hinsehen nicht stimmt" },
        ...
        ("Was ist ein Rhythmusbaustein?", new[] { "Ein kurzes, festgelegtes rhythmisches Muster, das als Baustein für eine Komposition dient", "Ein einzelner, isolierter Ton ohne jede rhythmische Bedeutung (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme", "Ein Begriff aus der Harmonielehre" },
        ...
        ("Warum eignet sich Gruppenimprovisation gut zum gemeinsamen Musizieren im Unterricht?", new[] { "Weil sie spontanes, kreatives Zusammenspiel ermöglicht, ohne dass jede Stimme vorher komponiert sein muss", "Weil sie ausschließlich Einzelspiel erlaubt", "Weil sie strengere Regeln als klassisches Notenspiel erfordert, was einer genaueren Pruefung nicht standhaelt" },
    ...
    {
        ("Was ist Kammermusik?", new[] { "Musik für eine kleine Besetzung, meist ein Instrument pro Stimme", "Musik ausschließlich für ein großes Orchester, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Popmusik" },
        ...
        ("Was ist Orchestermusik?", new[] { "Musik für eine große Besetzung verschiedener Instrumentengruppen", "Musik ausschließlich für ein einzelnes Instrument, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein anderes Wort für Kammermusik" },
        ...
        ("Was ist ein Sprechstück in der Musik?", new[] { "Ein Stück, bei dem Text rhythmisch gesprochen statt gesungen wird", "Ein Stück, das ausschließlich instrumental ist, auch wenn das manche zunaechst vermuten wuerden", "Ein Begriff aus der Harmonielehre" },
        ...
        ("Was ist ein Streichquartett als Beispiel für Kammermusik?", new[] { "Eine Besetzung aus zwei Violinen, Bratsche und Cello", "Eine Besetzung aus vier Blechblasinstrumenten, was bei genauerem Hinsehen nicht stimmt", "Ein vollständiges Symphonieorchester" },
        ...
        ("Was ist ein Symphonieorchester?", new[] { "Eine große Orchesterbesetzung mit Streichern, Holz- und Blechbläsern sowie Schlagwerk", "Eine kleine Besetzung mit nur einem Instrument pro Stimme (was so in der Praxis nicht zutrifft)", "Ein anderes Wort für einen Chor" },
        ...
        ("Was ist Vokalmusik allgemein?", new[] { "Musik, bei der die menschliche Singstimme im Mittelpunkt steht", "Musik, die ausschließlich von Instrumenten gespielt wird, was einer genaueren Pruefung nicht standhaelt", "Ein anderes Wort für Orchestermusik" },
        ...
        ("Was ist Instrumentalmusik allgemein?", new[] { "Musik, die ausschließlich mit Instrumenten ohne Gesang gespielt wird", "Musik, die ausschließlich gesungen wird, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Kammermusik" },
        ...
        ("Was unterscheidet ein Klaviertrio von einem Streichquartett?", new[] { "Ein Klaviertrio besteht aus Klavier, Violine und Cello, ein Streichquartett aus vier Streichinstrumenten ohne Klavier", "Beide Besetzungen sind identisch", "Ein Klaviertrio besteht immer aus vier Instrumenten, was die eigentliche Bedeutung des Begriffs verfehlt und deshalb hier nicht zutrifft" },
        ...
        ("Warum eignet sich Kammermusik gut für kleine, intime Aufführungsräume?", new[] { "Weil die kleine Besetzung auch in akustisch begrenzten Räumen gut zur Geltung kommt", "Weil Kammermusik grundsätzlich extrem laut gespielt werden muss", "Weil Kammermusik ausschließlich in großen Konzertsälen erlaubt ist, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" },
        ...
        ("Was zeichnet einen zweistimmigen Chorsatz musikalisch gegenüber einem einstimmigen Lied aus?", new[] { "Zwei unabhängige, gleichzeitig erklingende Gesangsstimmen statt nur einer einzigen Melodiestimme", "Er wird ausschließlich instrumental begleitet, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt", "Er besteht aus exakt vier Gesangsstimmen" },
        ...
        ("Was ist der Unterschied zwischen einem Lied und einem reinen Instrumentalstück?", new[] { "Ein Lied enthält gesungenen Text, ein Instrumentalstück wird ausschließlich mit Instrumenten gespielt", "Beide Begriffe bezeichnen exakt dasselbe", "Ein Instrumentalstück enthält immer gesungenen Text (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme" },
        ...
        ("Was ist ein Beispiel für ein modernes \"Sprechstück\" außerhalb klassischer Musik?", new[] { "Ein Poetry-Slam-Beitrag mit rhythmisch gesprochenem Text", "Eine klassische Opernarie mit gesungenem Text", "Ein rein instrumentales Orchesterstück ohne Text, was einer genaueren Pruefung nicht standhaelt" },
    ...
    {
        ("Was bedeutet \"Programmmusik\"?", new[] { "Instrumentalmusik, die eine außermusikalische Geschichte, Idee oder ein Bild musikalisch darstellen will", "Musik, die ausschließlich nach einem festen Notenprogramm ohne jede Freiheit gespielt wird, obwohl das auf den ersten Blick plausibel klingt", "Ein anderes Wort für Popmusik" },
        ...
        ("Was bedeutet der Zusammenhang von Text und Musik in einem Song?", new[] { "Melodie, Rhythmus und Musik unterstützen und verstärken die Aussage des Textes", "Text und Musik stehen in einem Song immer völlig unabhängig voneinander, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein Song besteht laut Definition ausschließlich aus Text ohne Musik" },
        ...
        ("Was ist Poptanz-Musik als Beispiel für funktionale Musik?", new[] { "Musik, die gezielt zum Tanzen in einem bestimmten Rhythmus komponiert oder ausgewählt wird", "Musik, die ausschließlich zum stillen, konzentrierten Zuhören gedacht ist und deshalb hier nicht zutrifft", "Ein anderes Wort für eine Nationalhymne" },
        ...
        ("Was bedeutet \"Hörweise\" im musikalischen Sinn?", new[] { "Die individuelle Art und Weise, wie eine Person Musik wahrnimmt und darauf reagiert", "Ein technischer Begriff für die Lautstärke eines Musikstücks, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Ein anderes Wort für eine Tonleiter" },
        ...
        ("Was ist ein Beispiel dafür, wie Musik in der Werbung gezielt Emotionen erzeugen soll?", new[] { "Ruhige, warme Musik bei einer Werbung für ein Familienprodukt, um Geborgenheit zu vermitteln", "Musik in der Werbung wird grundsätzlich zufällig und ohne jede Überlegung ausgewählt, auch wenn das manche zunaechst vermuten wuerden", "Werbemusik darf laut Definition niemals Emotionen ansprechen" },
        ...
        ("Was ist eine Nationalhymne?", new[] { "Ein feierliches Lied, das ein Land offiziell repräsentiert", "Ein rein privates Lied ohne jede öffentliche Bedeutung (was so in der Praxis nicht zutrifft)", "Ein anderes Wort für ein Tanzlied" },
        ...
        ("Was bedeutet \"außermusikalisches Programm\" bei Programmmusik?", new[] { "Eine Geschichte, ein Bild oder eine Idee außerhalb der Musik selbst, die musikalisch dargestellt werden soll", "Ein rein technisches Notationsprogramm am Computer", "Ein Begriff, der ausschließlich bei elektronischer Musik verwendet wird - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Wie kann ein Instrumentalstück eine Landschaft oder ein Ereignis musikalisch darstellen?", new[] { "Durch klangliche Mittel wie Tempo, Dynamik und Instrumentierung, die an das dargestellte Bild erinnern", "Ausschließlich durch gesungenen, beschreibenden Text", "Instrumentalmusik kann grundsätzlich keine Bilder oder Ereignisse darstellen, obwohl das auf den ersten Blick plausibel klingt" },
        ...
        ("Was bedeutet es, wenn Musik \"Stimmung transportiert\"?", new[] { "Die Musik erzeugt beim Hören ein bestimmtes Gefühl oder eine bestimmte Atmosphäre", "Musik hat grundsätzlich keinerlei Einfluss auf Gefühle", "Nur gesungene Musik kann laut Definition Stimmung transportieren, was die eigentliche Bedeutung des Begriffs verfehlt" },
    ...
    {
        ("Was ist ein Konzert als musikalische Veranstaltungsform?", new[] { "Eine öffentliche Aufführung von Musik vor Publikum", "Ein rein privates, unhörbares Musikstück und deshalb hier nicht zutrifft", "Ein Begriff aus der Notenschrift" },
        ...
        ("Was bedeutet Urheberrecht im Zusammenhang mit Musik?", new[] { "Das Recht der Urheber:innen (z.B. Komponist:innen), über die Nutzung ihres Werks zu bestimmen", "Ein Recht, das ausschließlich für Bücher, nie für Musik gilt, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Ein Begriff ohne rechtliche Bedeutung" },
        ...
        ("Was ist eine Musikepoche?", new[] { "Ein historischer Zeitabschnitt mit typischen musikalischen Stilmerkmalen", "Ein einzelnes, isoliertes Musikstück, was bei genauerem Hinsehen nicht stimmt (was so in der Praxis nicht zutrifft)", "Ein Begriff aus der Harmonielehre" },
        ...
        ("Was ist neben dem klassischen Konzert eine weitere typische musikalische Veranstaltungsform?", new[] { "Ein Musikfestival mit mehreren Bands/Künstler:innen", "Eine rein private, unhörbare Musikaufführung - eine verbreitete, aber falsche Annahme", "Ein Begriff aus der Notation" },
        ...
        ("Was gilt als typisches Merkmal der Barockmusik?", new[] { "Reich verzierte Melodien und der durchgehende Generalbass", "Ausschließlich elektronisch erzeugte Klänge, was die eigentliche Bedeutung des Begriffs verfehlt", "Vollständiger Verzicht auf jede Melodie" },
        ...
        ("Was gilt als typisches Merkmal der Musik der Klassik (Musikepoche, ca. 1730-1820)?", new[] { "Klare, ausgewogene Formen und übersichtliche Melodien", "Ausschließlich elektronisch erzeugte Klänge", "Vollständiger Verzicht auf jede Form von Struktur und deshalb hier nicht zutrifft" },
        ...
        ("Warum verändert sich Musik im Laufe der Geschichte?", new[] { "Weil sich Gesellschaft, Technik und musikalischer Geschmack ständig weiterentwickeln", "Weil Musik seit ihrer Erfindung komplett unverändert geblieben ist, was so nicht korrekt ist", "Weil sich Musik nur durch Zufall verändert, ohne erkennbare Gründe" },
        ...
        ("Wie unterscheidet sich das Musikhören heute typischerweise von früher (z.B. vor dem Internet)?", new[] { "Heute wird Musik oft über Streaming-Dienste jederzeit und überall abgerufen, früher oft über physische Tonträger wie Schallplatten", "Musikhören hat sich seit der Erfindung der Schallplatte nie verändert", "Musik konnte früher ausschließlich live gehört werden, nie aufgezeichnet - eine haeufige, aber unzutreffende Vorstellung, auch wenn das manche zunaechst vermuten wuerden" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] HarmonielehreUndPartiturlesenListe =
    {
        ...
        ("Aus welchen Intervallen ist ein Dur-Dreiklang aufgebaut?", new[] { "Große Terz + kleine Terz (von unten nach oben)", "Kleine Terz + große Terz", "Ausschließlich aus zwei großen Terzen, was bei genauerem Hinsehen nicht stimmt" },
        ...
        ("Aus welchen Intervallen ist ein Moll-Dreiklang aufgebaut?", new[] { "Kleine Terz + große Terz (von unten nach oben)", "Große Terz + kleine Terz", "Ausschließlich aus zwei kleinen Terzen (was so in der Praxis nicht zutrifft)" },
        ...
        ("Was ist eine Partitur?", new[] { "Die Gesamtnotation eines mehrstimmigen Musikstücks mit allen Instrumental-/Gesangsstimmen übereinander", "Eine einzelne, isolierte Notenzeile für ein einzelnes Instrument - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt", "Ein Begriff für ein rein mündlich überliefertes Musikstück" },
        ...
        ("Was zeigen die unterschiedlichen Notenzeilen einer Orchesterpartitur?", new[] { "Jede Zeile zeigt die Stimme eines bestimmten Instruments oder einer Instrumentengruppe", "Alle Zeilen zeigen immer exakt dieselbe Stimme", "Jede Zeile zeigt ausschließlich die Dynamik des Gesamtstücks, obwohl das auf den ersten Blick plausibel klingt" },
        ...
        ("Was ist eine Terz als musikalisches Intervall?", new[] { "Der Abstand von einem Ton zum übernächsten Ton der Tonleiter (z.B. C zu E)", "Der Abstand von einem Ton zum direkt benachbarten Ton", "Ein Begriff, der nur bei Blasinstrumenten verwendet wird, was die eigentliche Bedeutung des Begriffs verfehlt" },
        ...
        ("Wie kann man die Tonart eines Musikstücks anhand der Notenschrift bestimmen?", new[] { "Anhand der Anzahl und Art der Vorzeichen (Kreuze/b) am Beginn der Notenzeile", "Ausschließlich anhand der Lautstärke des Stücks und deshalb hier nicht zutrifft, was so nicht korrekt ist", "Anhand der Anzahl der verwendeten Instrumente" },
        ...
        ("Wie wird das Tempo eines Musikstücks häufig in einer Partitur angegeben?", new[] { "Durch eine Metronomangabe (z.B. ♩ = 120) oder ein italienisches Tempowort (z.B. Allegro)", "Ausschließlich durch die Anzahl der verwendeten Instrumente - eine haeufige, aber unzutreffende Vorstellung", "Durch die Tonart des Stücks" },
        ...
        ("Wie wird Dynamik (Lautstärkeverlauf) in einer Partitur oft angegeben?", new[] { "Durch Buchstaben wie p/f oder grafische Zeichen wie die Crescendo-/Decrescendo-Gabel", "Ausschließlich durch die Wahl der Tonart, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt", "Durch die Anzahl der Notenzeilen" },
    ...
    {
        ("Was ist ein musikalisches Motiv?", new[] { "Eine kurze, prägnante musikalische Idee, die als Baustein eines Werks dient", "Ein vollständiges, mehrminütiges Musikstück (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme", "Ein Begriff aus der Notation von Dynamik" },
        ...
        ("Was bedeutet \"Motivverarbeitung\"?", new[] { "Ein Motiv im Verlauf eines Stücks zu verändern, zu variieren oder weiterzuentwickeln", "Ein Motiv exakt unverändert immer wieder zu wiederholen", "Ein Begriff, der ausschließlich bei elektronischer Musik verwendet wird, was einer genaueren Pruefung nicht standhaelt" },
        ...
        ("Was ist eine Fuge?", new[] { "Ein polyphones Musikstück, bei dem ein Thema nacheinander in verschiedenen Stimmen imitierend eingeführt wird", "Ein rein homophones Musikstück ohne jede Stimmenführung, obwohl das auf den ersten Blick plausibel klingt, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein anderes Wort für eine Kadenz" },
        ...
        ("Wie ist die Sonatenhauptsatzform grob aufgebaut?", new[] { "Exposition - Durchführung - Reprise (oft mit abschließender Coda)", "Ausschließlich aus einem einzigen, unveränderlichen Teil und deshalb hier nicht zutrifft", "Strophe - Refrain - Strophe - Refrain" },
        ...
        ("Was bedeutet \"Homophonie\" in der Musik?", new[] { "Eine Hauptstimme (Melodie) wird von untergeordneten Begleitstimmen (Akkorden) begleitet", "Mehrere gleichrangige, unabhängige Stimmen erklingen gleichzeitig, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Ein Begriff, der ausschließlich Sprechstücke betrifft" },
        ...
        ("Was ist der zentrale Unterschied zwischen Homophonie und Polyphonie?", new[] { "Bei Homophonie dominiert eine Hauptstimme, bei Polyphonie sind mehrere Stimmen gleichrangig unabhängig", "Beide Begriffe bezeichnen exakt dasselbe Satzprinzip", "Polyphonie bedeutet, dass nur eine einzige Stimme erklingt, auch wenn das manche zunaechst vermuten wuerden" },
        ...
        ("Was bedeutet \"Arrangieren\" eines Musikstücks?", new[] { "Ein bestehendes Stück für eine andere Besetzung oder einen anderen Stil neu zu bearbeiten", "Ein Stück komplett neu zu komponieren, ohne jeden Bezug zum Original, was bei genauerem Hinsehen nicht stimmt", "Ein Begriff, der ausschließlich das Aufnehmen im Studio bezeichnet" },
        ...
        ("Was ist eine komplexe Songform, wie sie in moderner Popmusik oft vorkommt?", new[] { "Eine Abfolge wie Strophe-Refrain-Strophe-Refrain-Bridge-Refrain", "Ausschließlich ein einziger, sich niemals wiederholender Teil (was so in der Praxis nicht zutrifft)", "Eine Form, die ausschließlich aus Pausen besteht" },
        ...
        ("Was bedeutet Rhythmus- oder Melodieimprovisation im Kompositionsprozess?", new[] { "Spontanes Entwickeln rhythmischer oder melodischer Ideen als Ausgangspunkt für eine Komposition", "Ausschließlich das exakte Nachspielen einer bereits fertigen Komposition - eine verbreitete, aber falsche Annahme", "Ein Begriff, der mit Komposition nichts zu tun hat" },
        ...
        ("Warum ist Motivverarbeitung ein zentrales Prinzip vieler Kompositionen?", new[] { "Weil sie erlaubt, aus wenig musikalischem Material ein vielfältiges, zusammenhängendes Werk zu entwickeln", "Weil jedes Motiv in einem Werk nur genau einmal erklingen darf", "Weil Motivverarbeitung ausschließlich bei elektronischer Musik angewendet wird, was einer genaueren Pruefung nicht standhaelt" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] MedienUndDigitaleProduktionListe =
    {
        ...
        ("Was ist ein Remix?", new[] { "Eine veränderte, oft technisch neu bearbeitete Version eines bestehenden Musikstücks", "Ein komplett neues Stück ohne jeden Bezug zu einem bestehenden Original, obwohl das auf den ersten Blick plausibel klingt", "Ein Begriff aus der klassischen Notenschrift" },
        ...
        ("Was ist der Unterschied zwischen einem Original und einer Bearbeitung (z.B. Cover oder Remix)?", new[] { "Das Original ist die erste, ursprüngliche Version, die Bearbeitung verändert oder interpretiert es neu", "Beide Begriffe bezeichnen exakt dasselbe Stück", "Eine Bearbeitung entsteht immer vor dem Original, was die eigentliche Bedeutung des Begriffs verfehlt und deshalb hier nicht zutrifft" },
        ...
        ("Was bedeutet \"digitale Klangbearbeitung\"?", new[] { "Klänge mithilfe von Software nachträglich zu verändern, z.B. durch Hall, Delay oder Filter", "Ausschließlich das reine, unbearbeitete Aufnehmen von Klängen", "Ein Begriff, der nur bei klassischer Notenschrift verwendet wird, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" },
        ...
        ("Was ist Tontechnik allgemein?", new[] { "Die Lehre und Praxis von Aufnahme, Bearbeitung und Wiedergabe von Klang", "Ausschließlich die Lehre vom Notenlesen, auch wenn das manche zunaechst vermuten wuerden", "Ein Begriff aus der Harmonielehre" },
        ...
        ("Was ist ein Mikrofon in der Tontechnik?", new[] { "Ein Gerät, das Schallwellen in elektrische Signale umwandelt, um sie aufzunehmen", "Ein Gerät, das ausschließlich Bilder aufzeichnet, was bei genauerem Hinsehen nicht stimmt", "Ein Instrument aus der Streicherfamilie" },
        ...
        ("Was bedeutet \"Mischen\" (Mixing) einer Musikaufnahme?", new[] { "Die einzelnen aufgenommenen Spuren in Lautstärke, Klangfarbe und Position aufeinander abzustimmen", "Ausschließlich das physische Zusammenkleben von Tonbändern (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme", "Ein Begriff, der nur beim Live-Konzert verwendet wird" },
        ...
        ("Was ist eine DAW (Digital Audio Workstation), vereinfacht erklärt?", new[] { "Eine Software zum Aufnehmen, Bearbeiten und Mischen von Musik am Computer", "Ein physisches Musikinstrument aus der Klassik, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein Begriff aus der klassischen Harmonielehre" },
        ...
        ("Was ist ein Beispiel für digitale Klangbearbeitung?", new[] { "Das Hinzufügen von Hall (Reverb), um einen Klang räumlicher wirken zu lassen", "Das reine, unveränderte Abspielen einer Originalaufnahme und deshalb hier nicht zutrifft", "Das handschriftliche Notieren einer Melodie" },
        ...
        ("Was bedeutet es, wenn eine Gesangsaufnahme nachträglich stark digital \"korrigiert\" wird?", new[] { "Tonhöhen- oder Timing-Fehler werden nachträglich mit Software wie Autotune angepasst", "Die Aufnahme wird komplett neu und live ohne jede Technik eingesungen, was so nicht korrekt ist", "Die Aufnahme wird ausschließlich lauter gemacht" },
        ...
        ("Warum sollte man medial produzierte Musik kritisch reflektieren, statt sie unhinterfragt zu übernehmen?", new[] { "Weil technische Bearbeitung ein Bild erzeugen kann, das von der tatsächlichen musikalischen Leistung abweicht", "Weil medial produzierte Musik grundsätzlich fehlerfrei und unproblematisch ist - eine haeufige, aber unzutreffende Vorstellung", "Weil kritisches Nachdenken über Musik generell überflüssig ist" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] GattungenDerMusikgeschichteListe =
    {
        ...
        ("Was ist eine Sinfonie?", new[] { "Ein groß angelegtes, meist mehrsätziges Orchesterwerk", "Ein kurzes Solostück für ein einzelnes Instrument, obwohl das auf den ersten Blick plausibel klingt", "Ein Begriff aus der Popmusik" },
        ...
        ("Was ist eine Sinfonische Dichtung?", new[] { "Ein einsätziges Orchesterwerk, das ein außermusikalisches Programm (Geschichte, Bild) musikalisch darstellt", "Ein rein vokales Chorwerk ohne jedes Orchester, was die eigentliche Bedeutung des Begriffs verfehlt und deshalb hier nicht zutrifft", "Ein Begriff aus dem Jazz" },
        ...
        ("Was ist ein Solokonzert als Musikform?", new[] { "Ein Werk, bei dem ein Soloinstrument im Wechselspiel mit einem Orchester im Mittelpunkt steht", "Ein Werk ausschließlich für ein einzelnes Soloinstrument ohne jede Begleitung, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung", "Ein Begriff aus der Popmusik" },
        ...
        ("Was bedeutet Improvisation im Jazz?", new[] { "Spontanes, nicht vollständig vorher festgelegtes Musizieren innerhalb eines gegebenen musikalischen Rahmens", "Das exakte Nachspielen einer vollständig notierten Partitur, auch wenn das manche zunaechst vermuten wuerden, was bei genauerem Hinsehen nicht stimmt", "Ein Begriff, der im Jazz keine Rolle spielt" },
        ...
        ("Was sind \"Blue Notes\" im Jazz?", new[] { "Charakteristisch leicht \"verzogene\" (erniedrigte) Töne, die dem Jazz und Blues einen typischen Klangcharakter geben", "Töne, die ausschließlich in der Barockmusik verwendet werden (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme", "Ein Begriff aus der Notation von Rhythmen" },
        ...
        ("Was ist ein typisches Merkmal der Rockmusik?", new[] { "Der starke Einsatz von E-Gitarren, Bass und Schlagzeug mit oft kraftvollem Rhythmus", "Der vollständige Verzicht auf jedes elektrisch verstärkte Instrument, was einer genaueren Pruefung nicht standhaelt", "Ausschließlich rein akustische, unverstärkte Instrumente" },
        ...
        ("Warum vergleicht man Oper und Musical oft hinsichtlich musikalischer, inhaltlicher und historischer Merkmale?", new[] { "Weil beide Bühnenformen Musik und Handlung verbinden, sich aber in Stil, Entstehungszeit und Publikum unterscheiden", "Weil beide Formen in jeder Hinsicht exakt identisch sind", "Weil ein Vergleich zwischen beiden Formen musikalisch keinen Sinn ergibt, obwohl das auf den ersten Blick plausibel klingt" },
    ...
    private static readonly (string Frage, string[] Optionen, string Antwort, string Erklaerung)[] FilmmusikUndProgrammmusikListe =
    {
        ...
        ("Was ist die Leitmotivtechnik in der Filmmusik?", new[] { "Einer Figur, einem Ort oder einer Idee wird ein wiederkehrendes musikalisches Thema zugeordnet", "Jede Szene erhält ein komplett neues, niemals wiederkehrendes Thema, was die eigentliche Bedeutung des Begriffs verfehlt", "Ein Begriff, der ausschließlich im Jazz verwendet wird" },
        ...
        ("Was ist \"Underscoring\" in der Filmmusik?", new[] { "Musik, die dezent im Hintergrund läuft, um die Stimmung einer Szene zu unterstützen", "Musik, die ausschließlich lauter als der Dialog gespielt wird und deshalb hier nicht zutrifft", "Ein Begriff aus der Notenschrift für Vorzeichen" },
        ...
        ("Was ist das \"Wort-Ton-Verhältnis\" in einem Vokalstück?", new[] { "Das Zusammenspiel zwischen gesungenem Text und musikalischer Gestaltung", "Ausschließlich die Anzahl der Worte in einem Songtext, was so nicht korrekt ist", "Ein Begriff aus der reinen Instrumentalmusik" },
        ...
        ("Was ist ein Videoclip als Musikform?", new[] { "Eine visuelle, oft künstlerisch gestaltete Begleitung zu einem Musikstück", "Ein rein instrumentales Konzertstück ohne jedes Bildmaterial - eine haeufige, aber unzutreffende Vorstellung", "Ein Begriff aus der klassischen Notenschrift" },
        ...
        ("Was bedeutet \"Musik als Industriezweig\"?", new[] { "Musikproduktion, -vertrieb und -vermarktung als bedeutender wirtschaftlicher Wirtschaftsbereich", "Musik hat grundsätzlich keinerlei wirtschaftliche Bedeutung, auch wenn das manche zunaechst vermuten wuerden", "Ein Begriff, der ausschließlich klassische Musik betrifft" },
        ...
        ("Was ist ein Beispiel für politische Musik?", new[] { "Ein Protestsong, der gegen soziale Missstände oder für politische Veränderung eintritt", "Ein rein privates Wiegenlied ohne jeden politischen Bezug, was bei genauerem Hinsehen nicht stimmt", "Ein Begriff, der ausschließlich Nationalhymnen bezeichnet" },
        ...
        ("Was ist ein Beispiel für religiöse Musik?", new[] { "Ein Kirchenlied oder ein liturgischer Gesang im Gottesdienst", "Ein reiner Werbejingle für ein kommerzielles Produkt (was so in der Praxis nicht zutrifft)", "Ein rein instrumentales Jazz-Solostück" },
        ...
        ("Was ist ein zentraler Unterschied zwischen Filmmusik und (konzertanter) Programmmusik?", new[] { "Filmmusik begleitet unmittelbar bewegte Bilder, Programmmusik wird meist unabhängig im Konzertsaal aufgeführt", "Beide Begriffe bezeichnen exakt dasselbe - eine verbreitete, aber falsche Annahme, was einer genaueren Pruefung nicht standhaelt", "Programmmusik begleitet immer einen Film" },
        ...
        ("Warum ist die Musikindustrie wirtschaftlich bedeutsam?", new[] { "Weil sie Arbeitsplätze schafft und durch Verkauf, Streaming und Konzerte erhebliche Umsätze generiert", "Weil Musik grundsätzlich kostenlos und ohne jeden wirtschaftlichen Wert ist, obwohl das auf den ersten Blick plausibel klingt", "Weil die Musikindustrie ausschließlich von staatlichen Subventionen lebt" },
        ...
        ("Was ist ein Beispiel für ein musikalisches Leitmotiv?", new[] { "Ein wiederkehrendes Thema, das im gesamten Film mit einer bestimmten Figur assoziiert wird", "Ein Thema, das in einem Film nur genau einmal erklingen darf", "Ein Begriff, der ausschließlich in der Popmusik verwendet wird, was die eigentliche Bedeutung des Begriffs verfehlt" },
    ...
    {
        ("Was zeigt ein Epochenüberblick der Musikgeschichte typischerweise?", new[] { "Die grobe zeitliche Abfolge musikalischer Epochen wie Barock, Klassik, Romantik und Moderne", "Ausschließlich die Biografie eines einzigen Komponisten, auch wenn das manche zunaechst vermuten wuerden", "Ein Begriff, der ausschließlich die Gegenwart betrifft" },
        ...
        ("Was bedeutet \"Geschlechterstereotype in der Musik\"?", new[] { "Vorurteile darüber, welche Instrumente, Genres oder Berufe angeblich zu einem bestimmten Geschlecht \"passen\"", "Eine gesetzlich festgelegte Regel, welches Geschlecht welches Instrument spielen darf, was bei genauerem Hinsehen nicht stimmt", "Ein Begriff ohne Bezug zur Musikwelt" },
        ...
        ("Was ist eine Musikszene/Jugendkultur?", new[] { "Eine Gruppe mit gemeinsamem musikalischem Stil, Werten und oft eigenem äußeren Erscheinungsbild", "Eine staatliche Institution zur Musikförderung", "Ein Begriff, der ausschließlich klassische Musik betrifft (was so in der Praxis nicht zutrifft) - eine verbreitete, aber falsche Annahme" },
        ...
        ("Was bedeutet \"Musik und Herrschaft\"?", new[] { "Musik wurde historisch oft genutzt, um die Macht und Bedeutung eines Herrschers/Regimes zu demonstrieren", "Musik hatte in der Geschichte niemals einen Bezug zu Macht oder Herrschaft, was einer genaueren Pruefung nicht standhaelt", "Ein Begriff, der ausschließlich moderne Popmusik betrifft" },
        ...
        ("Was bedeutet \"Musik und Globalisierung\"?", new[] { "Musikstile verbreiten sich heute weltweit schnell, u.a. über Streaming-Dienste und das Internet", "Musik bleibt trotz weltweiter Vernetzung ausschließlich lokal begrenzt, obwohl das auf den ersten Blick plausibel klingt", "Ein Begriff, der mit Musik nichts zu tun hat" },
        ...
        ("Was ist ein historisches Beispiel dafür, wie Herrscher Musik zur Machtdemonstration genutzt haben?", new[] { "Aufwendige Hofmusik und Hofkapellen an europäischen Fürstenhöfen", "Ausschließlich private, unhörbare Musik ohne jedes Publikum und deshalb hier nicht zutrifft", "Ein Verbot jeglicher Musik am Hof" },
        ...
        ("Warum verändern sich Musikszenen/Jugendkulturen im Lauf der Zeit?", new[] { "Weil sich gesellschaftliche Werte, Technik und musikalischer Geschmack ständig weiterentwickeln", "Weil Musikszenen gesetzlich alle paar Jahre neu festgelegt werden", "Weil sich Jugendkulturen seit ihrer Entstehung nie verändert haben, was so nicht korrekt ist - eine haeufige, aber unzutreffende Vorstellung" },

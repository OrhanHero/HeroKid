...
public static class FinanceKnowledgeArticles
{
    ...
    public static NewsArticle GetForDate(DateOnly date, GradeLevel gradeLevel = GradeLevel.Klasse6)
    {
        ...
        return piece with
        {
            ...
            WhyImportant = KidNewsMetadata.WhyImportantFor(NewsCategory.Finanzen, gradeLevel),
            MeaningForKids = KidNewsMetadata.MeaningForKidsFor(NewsCategory.Finanzen, gradeLevel),
